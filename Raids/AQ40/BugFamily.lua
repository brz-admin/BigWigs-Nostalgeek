...
L:RegisterTranslations("frFR", function() return {
	...
	healbar = "Soins exceptionnels",
	healwarn = "Princesse Yauj commence \195\160 se soigner - Interrompez-la !!",
	attack_trigger1 = "Princesa Yauj attaque",
	attack_trigger2 = "Princess Yauj rate",
	attack_trigger3 = "Princesse Yauj touche",
	attack_trigger4 = "Princess Yauj inflige un coup critique",
	panic_bar = "Fear",
	first_panic_bar = "Fear Possible",
	panic_message = "Fear dans 3 Secondes!",
	toxicvolleyhit_trigger = "Salve toxique touche",
	toxicvolleyafflicted_trigger = "les effets de Salve toxique\.",
	toxicvolleyresist_trigger = "résistez à Salve toxique",
	toxicvolleyimmune_trigger = "Salva tóxica falla(.+) inmune",
	toxicvolley_bar = "Salve toxique",
	toxicvolley_message = "Salve toxique dans 3 secondes!",

	panic_trigger = "les effets de Peur%.",
	panicresist_trigger = "résisté à Peur",
	panicimmune_trigger = "Pánico falla(.+) inmune",

	toxicvaporsyou_trigger = "subissez les effets de Vapeur toxique\.",
	toxicvaporsother_trigger = "(.+) subis les effets de Vapeur toxique\.",

	toxicvaporsyou_trigger2 = "Vous subissez (%d+) de dégâts (.+) de Vapeur toxique de Seigneur Kri.",
	toxicvaporsother_trigger2 = "(.+) sibit (%d+) de dégât (.+) de Vapeur toxique de Seigneur Kri.",

	toxicvapors_message = "Bougez du nuage de Vapeur!",
	enrage_bar = "Enrager",
	warn5minutes = "Enrager dans 5 minutes!",
	warn3minutes = "Enrager dans 3 minutes!",
	warn90seconds = "Enrager dans 90 secondes!",
	warn60seconds = "Enrager dans 60 secondes!",
	warn30seconds = "Enrager dans 30 secondes!",
	warn10seconds = "Enrager dans 10 secondes!",
	kridead_message = "Kri est mort! Apparition de Nuages Toxique!",
	yaujdead_message = "Yauj est morte! Tuer les adds!",
	vemdead_message = "Vem est mort!",
	vemdeadcontkri_message = "Vem est mort! Kri est enragé!",
	vemdeadcontyauj_message = "Vem est mort! Yauj est enragée!",
	vemdeadcontboth_message = "Vem est mort! Kri et Yauj sont enragés!",
	enrage_trigger = "¡%s gagne Enrager",
	enrage_warning = "Enrager!",

	--panic_cmd = "panic",
	panic_name = "Alerte Peur",
	panic_desc = "Pr\195\169viens des Peurs de zone.",

	--toxicvolley_cmd = "toxicvolley",
	toxicvolley_name = "Salve toxique",
	toxicvolley_desc = "Prévien des salves toxique.",
	...
	--announce_cmd = "announce",
	announce_name = "Nuages Toxique",
	announce_desc = "Prévien les joueurs dans un Nuages Toxique.\n\n(besoin d'une assist)",

	--deathspecials_cmd = "deathspecials",
	deathspecials_name = "morts Spéciales",
	deathspecials_desc = "Prévien les joueurs de quel boss a été tué et de quelle sont les différentes abbilités.",

	--enrage_cmd = "enrage",
	enrage_name = "Enrager",
	enrage_desc = "Timer de l'enrage.",
} end )
