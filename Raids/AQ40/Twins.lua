...
L:RegisterTranslations("frFR", function() return {
	...
	--blizzard_cmd = "blizzard",
	blizzard_name = "Alerte du Blizzard",
	blizzard_desc = "Prévien si vous ête dans le blizzard",

	porttrigger = "gagne Téléportation des jumeaux.",
	portwarn = "Téléportation !",
	portdelaywarn = "Téléportation dans ~5 secondes !",
	portdelaywarn10 = "Téléportation dans ~10 secondes !",
	...
	blizzard_gone_trigger = "Blizzard se dissipe",
	blizzard_warn = "Enlevez vous du Blizzard!",


	pull_trigger1 = "Ah, lambs to the slaughter.",
	pull_trigger2 = "Prepare to embrace oblivion!",
	pull_trigger3 = "Rejoins-moi mon frère, il y a du sang à verser!",
	pull_trigger4 = "To decorate our halls.",
	pull_trigger5 = "Let none survive!",
	pull_trigger6 = "It's too late to turn away.",
	pull_trigger7 = "Look brother, fresh blood.",
	pull_trigger8 = "Like a fly in a web.",
	pull_trigger9 = "Shall be your undoing!",
	pull_trigger10 = "Votre arrogance!",

	kill_trigger = "Mon frère...NON!",
} end )
