...
L:RegisterTranslations("frFR", function() return {
	...
	--fear_cmd = "fear",
	fear_name = "Timer du fear",
	fear_desc = "Montre une barre de fear possible",

	--silence_cmd = "silence",
	silence_name = "Timer de silence",
	silence_desc = "Montre une barre de silence",

	--roots_cmd = "roots",
	roots_name = "Timer de Sarments",
	roots_desc = "Montre une barre pour sarments",

	--dust_cmd = "dust",
	dust_name = "Timer de nuage de poussiere",
	dust_desc = "Montre une barre  pour le nuage de poussiere",

	--warnings_cmd = "warnings",
	warnings_name = "Messages d'alerte",
	warnings_desc = "Montre les message d'alerte avec les deux capacités qu'a le mob en cours",

	fearTrigger = "Garde Anubisath commence à lancer Peur.",
	fearBar = "Fear!",
	fearBar_next = "Fear Possible",

	silenceTrigger = "Garde Anubisath commence à lancer Silence.",
	silenceBar = "Silence!",
	silenceBar_next = "Silence Possible",

	rootsTrigger = "Garde Anubisath commence à lancer Sarments.",
	rootsBar = "Sarments!",
	rootsBar_next = "Sarment Possible",

	dustTrigger = "Garde Anubisath commence à lancer Nuage de poussière.",
	dustBar = "Nuage de poussière!",
	dustBar_next = "Nuage de poussière Possible",

	dustWarn = "Nuage de poussière",
	dustWarn2 = "(Sarments ou Fear)",

	fearWarn = "Fear",
	fearWarn2 = "(Silence ou Nuage de poussière)",

	rootsWarn = "Enredederas",
	rootsWarn2 = "(Silence ou Nuage de poussière)",

	silenceWarn = "Silence",
	silenceWarn2 = "(Sarments ou Fear)",
