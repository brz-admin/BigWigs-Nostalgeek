...
L:RegisterTranslations("frFR", function() return {
	mcplayer = "Vous subissez les effets de Accomplissement v\195\169ritable%.",
	mcplayerother = "(.*) subit les effets de Accomplissement véritable.",
	mcplayeryouend = "Accomplissement véritable se dissipe de vous.",
	mcplayerotherend = "Accomplissement véritable se dissipe de (.*).",
	mcplayer_message = "Vous êtes sous controle mental !",
	mcplayerother_message = "%s est sous controle mental !",
	mindcontrol_bar = "CM: %s",
	deathyou_trigger = "Vous êtes mort.",
	deathother_trigger = "(.*) meurt.",
	splitsoon_message = "D\195\169multiplication bientôt! Soyez prêt!",
	split_message = "D\195\169multiplication!",
	kill_trigger = "You only delay",
	...
	--split_cmd = "split",
	split_name = "Alerte de Séparation",
	split_desc = "Préviens en cas de séparation",
