...
L:RegisterTranslations("frFR", function() return {
	...
	--entangle_cmd = "entangle",
	entangle_name = "Alerte de Enchevêtrement",
	entangle_desc = "Prévien de l'Enchevêtrement et des insectes",
	entangleplayer = "Vous ête affecté par Enchevêtrement.",
	entangleplayerother = "(.*) est affecté par Enchevêtrement.",
	entanglewarn = "Enchevêtrement!",
} end )
