...
L:RegisterTranslations("frFR", function() return {
	...
	frenzygain_trigger = "%s est pris de fr\195\169n\195\169sie !",
	frenzyend_trigger = "Frénésie se disspe de Princesse Huhuran.",
	frenzy_bar = "Frénésie",
	frenzy_Nextbar = "Frénésie Possible",
	frenzy_message = "Fr\195\169n\195\169sie - Tranq Shot !",
	...
	berserksoonwarn = "Enragée bientôt!",
