...
L:RegisterTranslations("frFR", function() return {
	...
	add_name = "Garde Royal de Sartura",
	starttrigger = "Vous serez jugé pour avoir profané ces lieux sacrés.",
	endtrigger = "Je sers au dernier!",
	startwarn = "Sartura engagé - 10 minutes avant Enrage!",
	enragetrigger = "devient fou furieux !",
	enragetrigger2 = "Garde de guerre Sartura gagne Frénésie.",
	berserktrigger = "devient fou furieux !",
	enragewarn = "Frénésie! Spam Heal!",
	berserkwarn = "Enrage!",
	berserktext = "Enrage",
	warn1 = "Enrage dans 5 minutes!",
	warn2 = "Enrage dans 3 minutes!",
	warn3 = "Enrage dans 90 secondes!",
	warn4 = "Enrage dans 60 secondes!",
	warn5 = "Enrage dans 30 secondes!",
	warn6 = "Enrage dans 10 secondes!",
	...
	whirlwindonwarn = "Tourbillon!",
	whirlwindoffwarn = "Tourbillon terminé - Go Stun!",
	whirlwindbartext = "Tourbillon",
	whirlwindnextbartext = "Tourbillon Possible",
	whirlwindfirstbartext = "Premier Tourbillon",
	whirlwindinctext = "Tourbillon en cours!",
	deadaddtrigger = "Garde royal de Sartura meurt.",
	deadbosstrigger = "Garde de guerre Sartura meurt.",
	addmsg = "%d/3 Garde royal de Sartura morts!",

	--adds_cmd = "adds",
	adds_name = "Compteur des adds",
	adds_desc = "Annonce quand un garde de Sartura meurt",
	...
	--berserk_cmd = "berserk",
	berserk_name = "Berserk",
	berserk_desc = "Prévien quand Sartura est en berserk",
