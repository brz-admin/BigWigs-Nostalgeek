...
L:RegisterTranslations("frFR", function() return {
	combat_trigger = " les ailes de",
	swarmbat_name = "Chauve-souris sanguinaire",
	bombbat_name = "Chauve-souris sanguinaire frénétique",
	...
	attack_trigger1 = "Grande prêtresse Jeklik attaque",
	attack_trigger2 = "Grande prêtresse Jeklik touche",
	attack_trigger3 = "Suma sacerdotisa Jeklik golpea",
	attack_trigger4 = "Suma sacerdotisa Jeklik golpe crítico",
	liquidfire_trigger = "Feu liquide",
	liquidfirehitsyou_trigger = "Feu liquide vous touche",
	liquidfirehitsother_trigger = "Feu liquide touche (.+)",
	...
	mindflayyou_trigger = "Vous subissez les effets de Fouet mental\.",
	mindflayother_trigger = "(.+) subit les effets de Fouet mental\.",
	mindflayendyou_trigger = "Fouet mental se dissipe de vous\.",
	mindflayend_trigger = "Fouet mental se dissipe de (.+)\.",
	...
	swarm_message = "Pack de Chauve-souris en approche ! Tuez les!",
	bomb_message = "Chauve-souris bombardier en approche ! Regardez où vous marchez!",
	fearinitext = "Fear",
	fearreptext = "Fear Possible",
	mindflaybar = "Fouet mental",
	greathealbar = "Soin",
	greathealtext = "Commence \195\160 se soigner ! Interrompez la!",
	phaseone_message = "Phase de Chauve-souris",
	phasetwo_message = "Phase de Troll",
	firewarn = "Bougez du feu!",
	firewarnyou = "Bougez du feu!",
	you = "vous",
	HighPriestessJeklik = "Grande prêtresse Jeklik",

	["Next Heal"] = "Prochain soin",
	["Fire Bombs"] = "Bombes de Feu",
	["First Silence"] = "Premier Silence",
	--cmd = "Jeklik",

	--phase_cmd = "phase",
	phase_name = "Alerte de Phase",
	phase_desc = "Prévien du changement de phase du boss",

	--heal_cmd = "heal",
	heal_name = "Alerte de soin",
	heal_desc = "Previen quand le boss va se heal",

	--flay_cmd = "flay",
	flay_name = "Alerte de Fouet mental",
	flay_desc = "Prévien du fouet mental",

	--fear_cmd = "fear",
	fear_name = "Alerte de Fear",
	fear_desc = "Prévien du Fear\n\n(Disclaimer: Les timers varient beaucoup, usuellement le fear arrive avec 10 sec de retard après la fin de la barre)",
	...
	swarm_bartext = "Pack de chauve-souris",

	--announce_cmd = "whispers",
	announce_name = "Chuchoter aux joueurs dans le feu",
	announce_desc = "Prévien les joueurs qui clask dans le feu\n\n(Necessite une promote)",
} end )
