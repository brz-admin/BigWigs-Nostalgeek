...
L:RegisterTranslations("frFR", function() return {
	...
	enrage_trigger = "Renataki gagne Enrager\.",
	enragesoon_message = "¡Enrager Bientôt! Préparez-vous!",
	enrage_message = "Enrager!",
	vanishsoon_message = "Vanish Bientôt!",
	vanish_message = "Le boss à Vanish!",
	unvanish_message = "Le boss est réaparu!",
	vanish_bar = "Vanish",
	return_bar = "Réaparition",

	--vanish_cmd = "vanish",
	vanish_name = "Alerte de vanish",
	vanish_desc = "Prévien quand le boss vanish.",

	--enraged_cmd = "enraged",
	enraged_name = "Alerte de Enrager",
	enraged_desc = "Préviens quand le boss enrage.",
} end )
