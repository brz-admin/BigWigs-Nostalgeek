...
L:RegisterTranslations("frFR", function() return {
	...
	renew_trigger                   = "Grand prêtre Venoxis gagne Rénovation\.",
	renewend_trigger                = "Rénovation se dissipe de Grand prêtre Venoxis\.",
	enrage_trigger                  = "Grand prêtre Venoxis gana Enrager\.",
	holyfire_trigger                = "Grand prêtre Venoxis commence à lancer Flammes sacrées\.",
	phase2_trigger                  = "Que se d\195\169roulent les anneaux de la haine !",
	attack_trigger1                 = "Grand prêtre Venoxis attaque",
	attack_trigger2                 = "Grand prêtre Venoxis falla",
	attack_trigger3                 = "Grand prêtre Venoxis touche",
	attack_trigger4                 = "Sumo sacerdote Venoxis golpe crítico",
	poisoncloud_trigger             = "Nuage empoisonné",
	poisoncloudhitsyou_trigger      = "Vous subissez (.+) de dégats de Nature de Nuage empoisonné de Grand prêtre Venoxis.",
	poisoncloudhitsother_trigger    = "(.+) subit (.+) de dégat de Nature de Nuage empoisonné de Grand prêtre Venoxis.",
	poisoncloud_on_you              = "Vous subissez les effets de Nuage empoisonné.",
	...
	deadaddtrigger                  = "Cobra Razzashi meurt",
	deadbosstrigger                 = "Grand prêtre Venoxis meurt",

	holyfirebar         = "Flammes sacrées",
	renewbar            = "Rénovation",
	renew_message       = "Rénovation! Dispel!",
	phase1_message      = "Phase de Troll",
	phase2_message      = "Phase de Serpent - Attention aux nuages de poison!",
	enrage_message      = "Enragé! Spam Heal!",
	poisonyou_message   = "Bougez du nuage de poison!",
	poison_message      = "Bougez du nuage de poison!",
	addmsg              = "%d/4 Cobras Razzashi morts!",
	you                 = "Vous",

	cmd                 = "Venoxis",

	--adds_cmd            = "adds",
	adds_name           = "Compteur d'adds morts",
	adds_desc           = "Annonce combien de Cobras Razzashi sont morts",

	--renew_cmd           = "renew",
	renew_name          = "Alerte de Rénovation",
	renew_desc          = "Prévien de la Rénovation",

	--holyfire_cmd        = "holyfire",
	holyfire_name       = "Alerte de Flammes sacrées",
	holyfire_desc       = "Prévien des Flammes sacrées",
	...
	--announce_cmd        = "whispers",
	announce_name       = "Chuchoter aux joueurs dans le nuage de poison",
	announce_desc       = "Chuchote aux joueurs qui sont dans le nuage de poison\n\n(Promotion requise)\n\n(Disclaimer: pour éviter le spam , il prévien seulement les joueurs qui prennent des dégat du nuage)",

	--enrage_cmd          = "enrage",
	enrage_name         = "Alerte de Enrager",
	enrage_desc         = "Prévien de l'enrage",
	["Next Holy Fire"] = "Prochaine Flammes sacrées",
} end )
