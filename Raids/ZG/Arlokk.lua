...
L:RegisterTranslations("enUS", function() return {
	...
	mark_fade = "Marque d'Arlokk se dissipe de (.+)\.",
...
L:RegisterTranslations("frFR", function() return {
	...
	mark_fade = "Marque d'Arlokk se dissipe de (.+)\.",
	ww_trigger = "Grande prêtresse Arlokk gagne \'Tourbillon\'\.",
	ww_bar = "Tourbillon",
	trollphase_message = "Phase Troll",
	pantherphase_message = "Phase Pantère",
	vanishphase_message = "Vanish!",
	vanish_bar = "Retour estimé",
	vanish_Nextbar = "Prochain Vanish",

	--vanish_cmd = "vanish",
	vanish_name = "Alerte Vanish",
	vanish_desc = "Prévien quand Arlokk Vanish.",

	--mark_cmd = "mark",
	mark_name = "Alerte Marque d'Arlokk",
	mark_desc = "Prévien quand les joueur sont marqués.",

	--whirlwind_cmd = "whirlwind",
	whirlwind_name = "Alerte Tourbillon",
	whirlwind_desc = "Prévien quand les boss va faire sont Tourbillon",

	--phase_cmd = "phase",
	phase_name = "Phase",
	phase_desc = "Prévien quand le boss change de phase",

	--puticon_cmd = "puticon",
	puticon_name = "Ic\195\180ne de raid",
	puticon_desc = "Place une ic\195\180ne de raid sur la derni\195\168re personne marqu\195\169e (requiert d'\195\170tre promus ou plus)",
} end )
