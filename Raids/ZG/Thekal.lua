...
L:RegisterTranslations("frFR", function() return {
	...
	phase2_trigger = " que ta puissance m'envahisse ",
	roguename = "Zélote Zath",
	shamanname = "Zélote Lor'Khan",
	phaseone_message = "Phase de Troll",
	phasetwo_message = "Phase de Tigre",
	phasetwo_bar = "Phase de Tigre",
	tigers_trigger = "Grand prêtre Thekal exécute Invocation de gardiens zuliens.",
	forcepunch_trigger = "Grand prêtre Thekal commence a exécuter Poing de force.",
	forcepunch_bar = "Poing de force",
	heal_trigger = "Zélote Lor'Khan commence \195\160 lancer Soins exceptionnels.",
	enrage_trigger = "Grand prêtre Thekal gagne Enrager\.",
	enrage_message = "Le boss est enragé! Spam Heal!",
	tigers_message = "Invocation de tigres!",
	heal_message = "Lor'Khan lance un soin! Interrompez-le!",
	heal_bar = "Soins exceptionnels",
	disarmself_trigger = "Vous subissez les effets de Désarmé.",
	disarmother_trigger = "(.+) subit les effets de Désarmé.",
	mortalcleaveself_trigger = "Vous subissez les effets de Enchaînement mortel.",
	mortalcleaveother_trigger = "(.+) subit les effets de Enchaînement mortel.",
	silenceself_trigger = "Vous subissez les effets de Silence.",
	silenceother_trigger = "(.+) subit les effets de Silence.",
	silenceselfend_trigger = "Silence se dissipe.",
	silenceotherend_trigger = "Silence se dissipe de (.+).",
	silence_announce = "Silence sur %s! Dispell!",
	mortalcleave_bar = "Enchaînement mortel: %s",
	silence_bar = "Silence: %s",
	disarm_bar = "Désarmé: %s",
	bloodlustgain = "(.+) gagne Furie sanguinaire.",
	bloodlustend = "Furie sanguinaire se dissipe de (.+).",
	bloodlust_bar = "Furie sanguinaire: %s",
	bloodlustannounce = "Dispell Furie sanguinaire de %s!",
	frenzybegin_trigger = "Grand prêtre Thekal gagne Frénésie.",
	frenzyend_trigger = "Frénésie se dissipe de Grand prêtre Thekal.",
	frenzyann = "Frénésie! Tranqshot!",
	frenzy_bar = "Frénésie",
	death_trigger = "meurt.",
	zath_trigger = "Zélote Zath",
	lorkhan_trigger = "Zélote Lor'Khan",
	thekal_trigger = "Grand prêtre Thekal",
	thekalrescast_trigger = "Grand prêtre Thekal commence à lancer Résurrection.",
	zathrescast_trigger = "Zélote Zath commence à lancer Résurrection.",
	lorkhanrescast_trigger = "Zélote Lor'Khan commence à lancer Résurrection.",

	--heal_cmd = "heal",
	heal_name = "Alerte de Heal",
	heal_desc = "Préviens quand Lor'Khan incante un heal.",

	--bloodlust_cmd = "bloodlust",
	bloodlust_name = "Alerte de Furie sanguinaire",
	bloodlust_desc = "Annonce quand le boss à Furie sanguinaire.",

	--silence_cmd = "silence",
	silence_name = "Silence",
	silence_desc = "Montre qui à le silence.",

	--disarm_cmd = "disarm",
	disarm_name = "Désarmé",
	disarm_desc = "Préviens du Désarmé de Lor'Khan.",

	--cleave_cmd = "cleave",
	cleave_name = "Alerte de Enchaînement mortel",
	cleave_desc = "Prévien de Enchaînement mortel.",

	--punch_cmd = "punch",
	punch_name = "Alerte de Poing de force",
	punch_desc = "Prévien pour le Poing de force",

	--tigers_cmd = "tigers",
	tigers_name = "Alerte de Tigres",
	tigers_desc = "Prévien quand les tigres apparaissent.",

	--frenzy_cmd = "frenzy",
	frenzy_name = "Alerte de Frénésie",
	frenzy_desc = "Prévien de la Fénésie.",

	--enraged_cmd = "enraged",
	enraged_name = "Alerte de Enrager",
	enraged_desc = "Prévien de l'enrage.",

	--phase_cmd = "phase",
	phase_name = "Alerte de Phase",
	phase_desc = "Annonce le changement de phase.",

	["You have slain %s!"] = "Vous avez tué %s!",
	["Knockback"] = "Knockback",
	["New Adds"] = "Nouveaux Tigres",
	["Next Bloodlust"] = "Pochaine Furie sanguinaire",
} end )
