...
L:RegisterTranslations("frFR", function() return {
	--cmd = "Hazzarah",
	nightmaresummon_trigger = "Hazza\'rah lance Invocation d'illusions cauchemardesques\.",
	nightmaresummon_message = "Tuez les Illusions!",

	--nightmaresummon_cmd = "spawns",
	nightmaresummon_name = "Alerte illusions",
	nightmaresummon_desc = "Previens quand le boss invoque des illisions",
} end )
