...
L:RegisterTranslations("frFR", function() return {
	...
	avatar_trigger = "Gri\'lek gagne Avatar\.",
	preavatar_warn = "Avatar bientôt! Cac eloignez-vous!",
	avatar_bar = "Avatar",
	avatar_message = "Avatar! Courrez loin du Boss!",
	avatar_end = "Avatar se dissipe",
	avatar_whisper_you = "Gri'lek vient sur toi! Court!",
	avatar_whisper = "Gri'lek vient sur toi! Court!",
	avatar_watch = "Gri'lek poursuit %s!",

	--avatar_cmd = "avatar",
	avatar_name = "Alerte de Avatar",
	avatar_desc = "Annonce quand le boss a Avatar.",

	--melee_cmd = "melee",
	melee_name = "Alerte pour les Cacs",
	melee_desc = "Previen avant que le boss lance Avatar pour que les cac s'éloignent.",

	--announce_cmd = "announce",
	announce_name = "Chuchoter aux joueurs",
	announce_desc = "Préviens les joueur en chuchoter qu'il sont la cible de Gri'lek",

	--puticon_cmd = "puticon",
	puticon_name = "Placer icone",
	puticon_desc = "Place une icone sur le joueur poursuivi par Gri'lek.\n\n(Necessite une promote ou plus)",
} end )
