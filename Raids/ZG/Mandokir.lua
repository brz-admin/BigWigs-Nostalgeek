...
L:RegisterTranslations("frFR", function() return {
	...
	engage_trigger = "à Hakkar lui-même",
	watch_trigger = "Je garde un oeil sur vous, ([^%s]+) !",
	gaze_trigger = "Seigneur sanglant Mandokir commence à lancer Regard menaçant.",
	gazeafflictyou = "Vous subissez les effets de Regard menaçant.",
	gazeafflictother = "(.+) subit les effets de Regard menaçant.",
	gazeendyou = "Regard menaçant se dissipe",
	gazeendother = "Regard menaçant se dissipe de (.+).",
	gazecast = "Regard menaçant",
	gazewatchedbar = "Regard menaçant: %s",
	...
	announce_cmd = "whispers",
	announce_name = "Chuchoter aux joueurs surveillés",
	announce_desc = "Chuchote aux joueurs qui sont surveillé(Necessite promote)",
	...
	whirlwind_desc = "Prévien du Tourbillon",

	enraged_cmd = "enraged",
	enraged_name = "Alerte Enrager",
	enraged_desc = "Prévien quand le boss est enragé",
