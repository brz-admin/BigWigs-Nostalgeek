...
L:RegisterTranslations("frFR", function() return {
	...
	Fear = "Cri d'intimidation",

	trigger1 = "les effets de Coup de tonnerre",
	trigger2 = "effets de Cri d'intimidation.",
	...
	bars_cmd = "bars",
	bars_name = "Alterner barres",
	bars_desc = "Alterne entre Montrer ou cacher les barres de timers.",
