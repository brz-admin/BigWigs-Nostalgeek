...
L:RegisterTranslations("frFR", function() return {
	...
	chainlightning_trigger = "Wushoolay commence à lancer Chaîne d'éclairs\.",
	chainlightning_bar = "Chaîne d'éclairs",
	chainlightning_message = "Chaîne d'éclairs! Go Kick!",
	lightningcloud_trigger = "Vous subissez les effets de Nuage d'éclairs\.",
	lightningcloud_message = "Sortez du Nuage d'éclairs!",

	chainlightning_cmd = "chainlightning",
	chainlightning_name = "Alerte Chaîne d'éclairs",
	chainlightning_desc = "Prévien quand le boss va lancer Chaîne d'éclairs.",

	lightningcloud_cmd = "lightningcloud",
	lightningcloud_name = "Alerte Nuage d'éclairs",
	lightningcloud_desc = "Prévien quand vous êtes dans un Nuage d'éclairs.",
} end )
