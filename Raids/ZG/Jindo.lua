...
L:RegisterTranslations("frFR", function() return {
	...
	curseself_trigger = "Vous subissez les effets de Illusions de Jin'do",
	curseother_trigger = "(.+)  subit les effets de Illusions de Jin'do.",
	hexself_trigger = "Vous subissez les effets de Maléfice.",
	hexother_trigger = "(.+) bubit les effets de Maléfice.",
	hexselfend_trigger = "Maléfice se dissipe.",
	hexotherend_trigger = "Maléfice se dissipe de (.+).",
	warnbrainwash = "Totem de Contr\195\180le Mental !!",
	warnhealing = "Totem de Soins !",
	jindo_death = "Jin'do le Mal\195\169ficieur meurt.",
	brainwash_death = "Totem de lavage de cerveau meurt.",
	healing_death = "Gardien guérisseur puissant meurt.",
	brainwash_bar = "Totem de lavage de cerveau",
	healing_bar = "Gardien guérisseur puissant",
	brainwash_next_bar = "Prochain Totem de lavage de cerveau",
	healing_next_bar = "Prochain Gardien guérisseur puissant",
	hex_bar = "Maléfice: %s",
	cursewarn_message = "Tu es maudit! Tue les Illusions!",
	cursewarn_warning = "%s est maudit!",
	hexwarn_warning = "%s est Maléficié! Dispell!",

	--cmd = "Jindo",

	--brainwash_cmd = "brainwash",
	brainwash_name = "Alerte de Totem de lavage de cerveau",
	brainwash_desc = "Pr\195\169viens du pop de totem de contr\195\180le mental.",

	--healingward_cmd = "healingward",
	healingward_name = "Alerte Totem de soins",
	healingward_desc = "Pr\195\169viens du pop de totem de soins.",

	--curse_cmd = "curse",
	curse_name = "Alerte de Ilusions de Jin'do",
	curse_desc = "Prévien quand un joueur à Ilusions de Jin'do.",

	--hex_cmd = "hex",
	hex_name = "Alerte de Maléfice",
	hex_desc = "Prévien quand un joueur à Maléfice.",

	--puticon_cmd = "puticon",
	puticon_name = "Ic\195\180ne de raid",
	puticon_desc = "Place une ic\195\180ne de raid sur la derni\195\168re personne maudite (requiert d'\195\170tre promus ou plus)",
} end )
