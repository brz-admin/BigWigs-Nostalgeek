...
L:RegisterTranslations("frFR", function() return {
	...
	flamebuffetafflicted_trigger = "les effets de Rafale de flammes",
	...
	flamebuffetabsorb2_trigger = "Rafale de flammes est absorbé",

	wingbuffet_message = "Frappe des ailes! Prochaine dans 30 secondes!",
	...
	flamebuffet_bar = "Rafale de flammes",

	--cmd = "Firemaw",

	--flamebuffet_cmd = "flamebuffet",
	flamebuffet_name = "Alerte de Rafale de flammes",
	flamebuffet_desc = "Prévien quand le boss lance Rafale de flammes.",

	--wingbuffet_cmd = "wingbuffet",
	wingbuffet_name = "Alerte de Frappe des ailes",
	wingbuffet_desc = "Prévien quand le boss lance Frappe des ailes.",

	--shadowflame_cmd = "shadowflame",
	shadowflame_name = "Alerte de Flamme d'ombre",
	shadowflame_desc = "Prévien quand le boss lnce Flamme d'ombre.",
} end)
