...
L:RegisterTranslations("frFR", function() return {
	...
	engage_trigger = "None of your kind should be here",
	ms_trigger = "Frappe mortelle DE Seigneur des couvées Lanistaire touche ([^%s]+)",
	bw_trigger = "^(.+) (.+) les effets de Vague explosive",
	deathyou_trigger = "Vous êtes mort\.",
	deathother_trigger = "(.+) meurt\.",
	ms_warn_you = "Frappe mortelle sur toi !",
	ms_warn_other = "Frappe mortelle : %s !",
	bw_warn = "Vague explosive imminente!",
	ms_bar = "Frappe mortelle: %s",
	bw_bar = "Vague explosive",
	knock_bar = "Repousser au loin possible",

	["First Mortal Strike"] = "Première Frappe mortelle",

	you = "Vous",
	are = "subissez",

	--ms_cmd = "ms",
	ms_name = "Alerte Frappe mortelle",
	ms_desc = "Prévien quand un joueur à Frappe mortelle et montre une barre cliquable pour sélectionner facilement.",

	--knock_cmd = "knock",
	knock_name = "Alerte Repousser au loin",
	knock_desc = "Montre une barre pour le Repousser au loin possible.",

	--bw_cmd = "bw",
	bw_name = "Vague explosive",
	bw_desc = "Montre une barre pour la Vague explosive.\n\n(Disclaimer: cela varie de 8 à 15 secondes. Choisissez le plus petit interval pour être safe.)",
} end )
