...
L:RegisterTranslations("frFR", function() return {
	...
	shadowcurseyou_trigger = "Vous subissez les effets de Ombre de Roch\195\169b\195\168ne.\.",
	shadowcurseother_trigger = "(.+) subit les effets de Ombre de Roch\195\169b\195\168ne\.",
	wingbuffet_message = "Frappe des ailes ! La prochaine dans 30 secondes!",
	wingbuffet_warning = "TAUNT maintenant! Frappe des ailes imminente!",
	shadowflame_warning = "Flamme d'ombre imminente !",
	shadowfcurse_message_you = "Vous avez l'Ombre de Roch\195\169b\195\168ne !",
	shadowfcurse_message_taunt = "%s à l'Ombre de Roch\195\169b\195\168ne! TAUNT!",

	wingbuffetcast_bar = "Frappe des ailes",
	wingbuffet_bar = "Prochaine Frappe des ailes",
	wingbuffet1_bar = "Frappe des ailes Initiale",
	shadowflame_bar = "Flamme d'ombre",
	shadowflame_Nextbar = "Prochaine Flamme d'ombre",
	shadowcurse_bar = "%s - Ombre de Roch\195\169b\195\168ne",
	shadowcurse_Firstbar = "Ombre de Roch\195\169b\195\168ne Initiale",
	...
	--curse_cmd = "curse",
	curse_name = "Alerte Ombre de Roch\195\169b\195\168ne",
	curse_desc = "Montre une barre de timer et annonce qui a l'Ombre de Roch\195\169b\195\168ne.",
} end)
