...
L:RegisterTranslations("frFR", function() return {
	...
	--breathcd_cmd = "breathcd",
	breathcd_name = "Alerte vocal pour les souffles",
	breathcd_desc = "Joue un son pour les souffles.",
	...
	vulnerability_direct_test = "^.+ lance .+ sur Chromaggus et lui (.+) ([%d]+) points de dégâts .+ (.+)%.", -- [Fashu's] [Firebolt] [hits] Battleguard Sartura for [44] [Fire] damage. ([14] resisted)
	vulnerability_dots_test = "^Chromaggus subit ([%d]+) ([%w]+) dégât de [%w]+[%s]* ([%w%s:]+)%.[%s%(]*([%d]*)",
	frenzy_trigger = "Chromaggus entre dans une fr\195\169n\195\169sie sanglante !",
	frenzyfade_trigger = "Frénésie se dissipe de Chromaggus\.",
	vulnerability_trigger = "tandis que sa peau miroite.", -- ***

	hit = "inflige",
	crit = "critique",

	firstbreaths_warning = "Souffle dans 5 secondes!",
	breath_warning = "%s dans 10 secondes !",
	...
	frenzy_message = "Frénésie! Tir Tranquilisant maintenant!",
	...
	first_bar = "Premier Souffle",
	second_bar = "Second Souffle",
	vuln_bar = "%s Vulnerabilitée",
	...
	curseofdoom = "Malédiction Funeste",
	ignite = "Enflammer",
