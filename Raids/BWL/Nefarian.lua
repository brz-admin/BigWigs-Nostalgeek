...
L:RegisterTranslations("enUS", function() return {
	...
	shadowcurseyou_trigger = "Vous subissez les effet de Voile de l'ombre\.",
	shadowcurseother_trigger = "(.+) subit les effets de Voile de l'ombre\.",

	triggerfear = "by Panic.",
	land = "Atterissage estimé",
	Mob_Spawn = "Apparition des Mobs",
	fear_warn = "Fear MAINTENANT!",

    triggershamans    = "Shamans, show me",
    triggerdruid    = "Druids and your",
    triggerwarlock    = "Warlocks, you ",
    triggerpriest    = "Priests! If you",
    triggerhunter    = "Hunters and your",
    triggerwarrior    = "Warriors, I",
    triggerrogue    = "Rogues? Stop",
	...
	mcplayer = "^([^%s]+) ([^%s]+) afflicted by Ordre d'ombre.$",
	mcplayerwarn = " est contrôlé mentalement!",
	mcyou = "Vous",
	mcare = "are",
...
L:RegisterTranslations("frFR", function() return {
	engage_trigger = "Que les jeux commencent!",
	landing_trigger = "BR\195\155LEZ, mis\195\169rables",
	landingNOW_trigger = "courage begins to wane",
	zerg_trigger = "C'est impossible ! Relevez",
	fear_trigger = "Nefarian commence \195\160 lancer Rugissement puissant",
	fear_over_trigger = "Rugissement puissant",
	...
	land = "Atterissage estimé",
	Mob_Spawn = "Apparition des Draconides",
	fear_warn = "Fear MAINTENANT!",

    triggershamans    = "Chamans, montrez",
    triggerdruid    = "Les druides et leur",
    triggerwarlock    = "Démonistes, vous",
    triggerpriest    = "Prêtres ! Si vous",
    triggerhunter    = "Ah, les chasseurs",
    triggerwarrior    = "Guerriers, je sais que",
    triggerrogue    = "Voleurs, ",
    triggerpaladin    = "Les paladins…",
    triggermage    = "Les mages aussi",

	landing_warning = "Nefarian atterit !",
	zerg_warning = "Zergs imminent !",
	fear_warning = "Fear dans 2 secondes!",
	fear_soon_warning = "Fear possible dans ~5 secondes",
	shadowflame_warning = "Flamme d'ombre imminente !",
	shadowflame_bar = "Flamme d'ombre",
	...
	fear_bar = "Fear possible",

	curse_bar = "Voile de l'ombre",
	...
	--curse_cmd = "curse",
	curse_name = "Voile de l'ombre",
	curse_desc = "Montre une barre de timer pour le Voile de l'ombre.",

	--mc_cmd = "mc",
	mc_name = "Alerte de Contrôle mental",
	mc_desc = "Prévien du Contrôle mental",
	mcwarn = "Contrôle mental!",
	mcplayer = "^([^%s]+) ([^%s]+) les effets de Ordre d'ombre.$",
	mcplayerwarn = " est contrôlé mentalement!",
	mcyou = "Vous",
	mcare = "subissez",

	-- nef counter
	["NefCounter_Trigger"] = "^([%w ]+) meurt.",

	["NefCounter_RED"] = "Drakônide rouge",
	["NefCounter_GREEN"] = "Drakônide vert",
	["NefCounter_BLUE"] = "Drakônide bleu",
	["NefCounter_BRONZE"] = "Drakônide bronze",
	["NefCounter_BLACK"] = "Drakônide chromatique",
	["NefCounter_CHROMATIC"] = "Drakônide cromático",
	["Drakonids dead"] = "Draconides morts",
} end)
