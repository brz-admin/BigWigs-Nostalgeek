...
L:RegisterTranslations("enUS", function() return {
	...
	polymorphother_trigger = "(.+) subit les effets de Métamorphose supérieure\.",
	polymorphyou_trigger = "Vous subissez les effets de Métamorphose supérieure\.",
	polymorph_message = "%s est Métamorphosé! Dispel!",
	polymorph_message_you = "Vous êtes Métamorphosé!",
	polymorph_bar = "Métamorphose: %s",
	polymorphyouend_trigger = "Métamorphose supérieure se dissipe de vous\.",
	polymorphotherend_trigger = "Métamorphose supérieure se dissipe de (.+)\.",
	deathyou_trigger = "Vous êtes mort\.",
	deathother_trigger = "(.+) meurt\.",
	egg_trigger = "Tranchetripe l'Indompté commence à lancer Détruire l'Oeuf\.",
	egg_message = "%d/30 Oeufs détruits!",
	egg_bar = "Détruire l'Oeuf",
...
L:RegisterTranslations("frFR", function() return {
	...
	mobs_soon = "Arrivée des gardes dans 5 secondes !",
	mobs_bar = "Arrivée des gardes",
	orbcontrolother_trigger = "(.+) subit les effets de Epuisement de l'esprit.",
	orbcontrolyou_trigger = "Vous subissez les effets de Epuisement de l'esprit.",
	mindcontrolother_trigger = "(.+) subit les effets de Emprise.",
	mindcontrolyou_trigger = "Vous subissez les effets de Emprise.",
	mindcontrol_message = "%s est sous Contr\195\180le mental !!",
	mindcontrol_message_you = "Vous êtes sous Contrôle mental!",
	mindcontrol_bar = "CM: %s",
	mindcontrolyouend_trigger = "Emprise se dissipe.",
	mindcontrolotherend_trigger = "Emprise se dissipe de (.+).",
	polymorphother_trigger = "(.+) subit les effets de Métamorphose supérieure.",
	polymorphyou_trigger = "Vous subissez les effets de Métamorphose supérieure.",
	polymorph_message = "%s est Métamorphosé! Dispel!",
	polymorph_message_you = "Vous êtes Métamorphosé!",
	polymorph_bar = "Métamorphose: %s",
	polymorphyouend_trigger = "Métamorphose supérieure se dissipe.",
	polymorphotherend_trigger = "Métamorphose supérieure se dissipe de (.+).",
	deathyou_trigger = "Vous êtes mort\.",
	deathother_trigger = "(.+) est mort\.",
	egg_trigger = "Tranchetripe l'Indompté lance Détruire l'Oeuf.",
	egg_message = "%d oeufs sur 30 détruits !",
	egg_bar = "Oeufs détruits",
	-- there is no clear phase2 trigger
	phase2_trigger = "Flammes échauffantes .+ Tranchetripe l'Indompté guérit Tranchetripe l'Indompté de .* points de vie%.", --"You'll pay for forcing me to do this.",
	phase2_message = "Tous les oeufs ont été détruits ! Phase 2!",
	volley_trigger = "Tranchetripe l'Indompté commence à lancer Volée de Boules de feu\.",
	volley_bar = "Volée de Boules de feu",
	volley_message = "Cachez vous!",
	conflagration_trigger = "les effets de Déflagration",
	conflagration_bar = "Déflagration",
	warstomp_bar = "Choc martial",
	orb_bar = "Controle de l Orbe: %s",
	destroyegg_yell1 = "Vous allez payer cher",
	destroyegg_yell2 = "Imbéciles! ",
	destroyegg_yell3 = "Non ! Pas un autre ! ",
	["Eggs destroyed"] = "Oeufs Détruits",
	...
	--eggs_cmd = "eggs",
	eggs_name = "Oeufs",
	eggs_desc = "Compteur d'oeuf détruit.",

	--phase_cmd = "phase",
	phase_name = "Phase",
	phase_desc = "Prévien du changement de phase.",

	--mobs_cmd = "mobs",
	mobs_name = "Première vague",
	mobs_desc = "Vous montre quand la première vague de mobs arrive.",

	--orb_cmd = "orb",
	orb_name = "Contrôle de l'Orbe",
	orb_desc = "Vous montre qui contrôle le boss et montre une barre cliquable pour une sélection facile.",

	--fireballvolley_cmd = "fireballvolley",
	fireballvolley_name = "Alerte Volée de boules de feu",
	fireballvolley_desc = "Préviens de l'arrivée des Volée de boules de feu.",

	--conflagration_cmd = "conflagration",
	conflagration_name = "Alerte Déflagration",
	conflagration_desc = "Montre une barre avec la durée de la déflagration.",

	--polymorph_cmd = "polymorph",
	polymorph_name = "Alerte Métamorphose supérieure",
	polymorph_desc = "montre qui est Métamorphosé par Grethok et montre une barre cliquable pour sélectionner facilement.",

	--icon_cmd = "icon",
	icon_name = "Icone pour le Contrôle mental",
	icon_desc = "Place une icone sur le joueur contrôlé pour la durée du débuff.\n\n(Requiers une promote)",
} end)
