...
L:RegisterTranslations("frFR", function() return {
	...
	adrenaline_trigger = "^(.+) (.+) les effets de Mont\195\169e d'adr\195\169naline.\.",
	start_trigger = "les effets de Essence du Rouge",
	flamebreath_trigger = "Vaelastrasz le Corrompu commence à lancer Souffle de flammes\.",
	yell1 = "^Trop tard... mes amis. ",
	yell2 = "^Je vous en supplie mortels, ",
	yell3 = "^FLAMMES ! MORT ! DESTRUCTION !",
	start_bar = "Début",
	tankburn_bar = "Tank brûle",
	adrenaline_bar = "Montée d'adrénaline: %s",
	breath_bar = "Souffle de flammes",
	breath_message = "Souffle de flammes!",
	tankburnsoon = "Montée d'adrénaline sur Tank dans 5 secondes!",
	adrenaline_message = "%s à Montée d'adrénaline!",
	adrenaline_message_you = "Vous avez Montée d'adrénaline! Bougez du raid!",
	...
	--start_cmd = "start",
	start_name = "Début",
	start_desc = "Montre une barre qui estime le début du combat.",

	--flamebreath_cmd = "flamebreath",
	flamebreath_name = "Alerte Souffle de flammes",
	flamebreath_desc = "Prévien quand le boss va lancer Souffle de flammes.",

	--adrenaline_cmd = "adrenaline",
	adrenaline_name = "Montée d'adrénaline",
	adrenaline_desc = "Annonce qui à la Montée d'adrénaline(bombe) et montre une barre clicquable pour sélectionner facilement.",

	--whisper_cmd = "whisper",
	whisper_name = "Chuchoter",
	whisper_desc = "Chuchote aux joueur qui ont la Montée d'adrénaline pour leur dire de bouger du raid.",

	--tankburn_cmd = "tankburn",
	tankburn_name = "Bombe sur Tank",
	tankburn_desc = "Montre une barre pour la Montée d'adrénaline qui sera mise sur le tank.",

	--icon_cmd = "icon",
	icon_name = "Icone pour Montée d'adrénaline",
	icon_desc = "place une icone sur le joueur qui à Montée d'adrénaline pour le localiser facilement.\n\n(Requiers une promote)",
} end)
