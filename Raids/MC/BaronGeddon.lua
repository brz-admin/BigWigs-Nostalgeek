...
L:RegisterTranslations("frFR", function() return {
	...
	ignitemana_trigger = "les effets de Enflammer le mana",
	bombyou_trigger = "Vous subissez les effets de Bombe vivante%.",
	bombother_trigger = "(.*) subit les effets de Bombe vivante%.",
	bombyouend_trigger = "Bombe vivante se dissipe.",
	bombotherend_trigger = "Bombe vivante se dissipe de (.*).",
	ignitemana_trigger1 = "les effets de Enflammer le mana",
	...
	bomb_message_youscreen = "Vous êtes la bombe !",
	bomb_message_other = "%s est la bombe !",

	bomb_bar = "Bombe vivante: %s",
	bomb_bar1 = "Bombe vivante: %s",
	inferno_bar = "Prochain Inferno",
	inferno_channel = "Inferno",
	nextinferno_message = "3 secondes avant Inferno!",
	service_bar = "Dernier service",
	nextbomb_bar = "Prochaine Bombe vivante",
	ignite_bar = "Enflammer le mana Possible",

	service_message = "Dernier Service, Geddon explose dans 8 secondes !",
	inferno_message = "Inferno pendant 8 secondes!",
	ignite_message = "Dispell MAINTENANT!",
	...
	--bomb_cmd = "bomb",
	bomb_name = "Alerte Bombe vivante",
	bomb_desc = "Prévien quand un joueur à la Bombe.",

	--mana_cmd = "manaignite",
	mana_name = "Alerte de Enflammer le mana",
	mana_desc = "Montre une barre de timer pour Enflammer le mana et annonce le dispell",
	...
	--announce_cmd = "whispers",
	announce_name = "Chuchoter aux porteurs de la Bombe",
	announce_desc = "Chuchote aux joueurs qui ont la Bombe. (Requiers promote)",
} end)
