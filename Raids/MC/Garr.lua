...
L:RegisterTranslations("frFR", function() return {
	firesworn_name = "Lige du feu",
	triggeradddead8 = "Garr gagne Enrager(.+)8",
	triggeradddead7 = "Garr hace gagne Enrager(.+)7",
	triggeradddead6 = "Garr hace gagne Enrager(.+)6",
	triggeradddead5 = "Garr gagne Enrager(.+)5",
	triggeradddead4 = "Garr gagne Enrager(.+)4",
	triggeradddead3 = "Garr gagne Enrager(.+)3",
	triggeradddead2 = "Garr gagne Enrager(.+)2",
	triggeradddead1 = "Garr gagne Enrager.",

	counterbarMsg = "Lige du feu morts",
	addmsg1 = "1/8 Lige du feu mort!",
	addmsg2 = "2/8 Lige du feu morts!",
	addmsg3 = "3/8 Lige du feu morts!",
	addmsg4 = "4/8 Lige du feu morts!",
	addmsg5 = "5/8 Lige du feu morts!",
	addmsg6 = "6/8 Lige du feu morts!",
	addmsg7 = "7/8 Lige du feu morts!",
	addmsg8 = "8/8 Lige du feu morts!",

	--cmd = "Garr",

	--adds_cmd = "adds",
	adds_name = "Compteur de Lige du feu",
	adds_desc = "Annonce les Lige du feu morts",
} end)
