...
L:RegisterTranslations("frFR", function() return {
	...
	shock_trigger = "Horion de l'ombre touche",
	shock_trigger2 = "résistez à Horion de l'ombre de Lucifron",
	curse_trigger2 = "résistez à Mal\195\169diction de Lucifron",
	doom_trigger2 = "résistez à Mal\195\169diction imminente de Lucifron",
	curse_warn_soon = "5 secondes avant Mal\195\169diction de Lucifron !",
	curse_warn_now = "Mal\195\169diction de Lucifron - 15 sec avant prochaine !",
	doom_warn_soon = "5 secondes avant Mal\195\169diction imminente !",
	doom_warn_now = "Mal\195\169diction imminente - 20 sec avant prochaine !",
	...
	deadaddtrigger = "Protecteur attise-flammes meurt",
	add_name = "Protecteur attise-flammes",

	mindcontrol_message = "%s est conrôlé mentalement!",
	mindcontrol_message_you = "Vous êtes contrôlé mentalement!",
	mindcontrol_bar = "CM: %s",
	addmsg = "%d/2 Protecteur attise-flammes mort!",

	curse_bar = "Mal\195\169diction de Lucifron",
	doom_bar = "Mal\195\169diction imminente",
	shock_bar = "Horion de l'ombre",

	--cmd = "Lucifron",

	--adds_cmd = "adds",
	adds_name = "Compteur de Protecteur attise-flammes",
	adds_desc = "Annonce quand les Protecteur attise-flammes meurts",

	--mc_cmd = "mc",
	mc_name = "Alerte Contrôle mental",
	mc_desc = "Prévien quand un joueur est contrôler mentalement.",
	...
	--shock_cmd = "shock",
	shock_name = "Alerte de Horion de l'ombre",
	shock_desc  = "Préviens de l'Horion de l'ombre",
} end)
