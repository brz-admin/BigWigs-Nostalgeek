...
L:RegisterTranslations("frFR", function() return {
	corerager_name = "Rageur du Magma",
	earthquakesoonwarn = "Tremblement de terre imminent!",
	golemaggenrage = "Golemagg l'Incinérateur gagne Enrager",
	enragewarn = "Golemagg est enragé!",

	--cmd = "Golemagg",

	--enraged_cmd = "enraged",
	enraged_name = "Alerte de Enrager",
	enraged_desc = "Annonce quand Golemagg enrage",

	--earthquake_cmd = "earthquake",
	earthquake_name = "Alerte de Tremblement de terre",
	earthquake_desc = "Annonce quand il est temps de reculez aux cacs",
} end)
