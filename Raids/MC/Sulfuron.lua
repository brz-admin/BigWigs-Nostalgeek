...
L:RegisterTranslations("frFR", function() return {
	triggeradddead = "Prêtre Attise-flammes meurt.",
	triggercast = "commence à lancer Guérison ténébreuse",
	spear_cast = "commence à lancer Lance de flammes",
	healbar = "Guérison ténébreuse",
	...
	flamewakerpriest_name = "Prêtre Attise-flammes",

	addmsg = "%d/4 Prêtre Attise-flammes morts!",
	...
	heal_desc = "Previen quand un Prêtre Attise-flammes heal",

	--adds_cmd = "adds",
	adds_name = "Compteur de Prêtre Attise-flammes morts",
