...
L:RegisterTranslations("frFR", function() return {
	blink_trigger = "Shazzrah lance Porte de Shazzrah.",
	deaden_trigger = "Shazzrah gagne Amortissement de la magie.",
	curse_trigger = "Shazzrah lance Malédiction de Shazzrah.",
	cs_trigger2 = "Shazzrah lance Contresort.",
	cs_trigger = "Resistido Contrahechizo de Shazzrah",
	curse_trigger2 = "Shazzrah lance Malédiction de Shazzrah.",
	deaden_over_trigger = "Amortissement de la magie se dissipe de Shazzrah",

	blink_warn = "Transfert ! - ~45 secondes avant le prochain",
	blink_soon_warn = "~5 secondes avant Transfert !",
	deaden_warn = "Shazzrah se buff ! - Dispellez le",
	curse_warn = "Malédiction de Shazzrah! Décurse MAINTENANT!",
	cs_now_warn = "Contresort! ~18 secondes avant le prochain!",
	cs_soon_warn = "3 secondes avant Contresort!",

	blink_bar = "Transfert Possible",
	deaden_bar = "Amortissement de la magie",
	curse_bar = "Malédiction de Shazzrah",
	cs_bar = "Contresort Possible",
