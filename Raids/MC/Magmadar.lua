...
L:RegisterTranslations("frFR", function() return {
	...
	panic_trigger = " les effets de Panique.",
	panic_trigger2 = "falla(.+) Pánico inmune.",
	panic_trigger3 = "Resistido Pánico de Magmadar",
	frenzy_bar = "Frénésie",
	frenzyfade_trigger = "Frénésie se dissipe",

	-- Warnings and bar texts
	frenzyann = "Alerte fr\195\169n\195\169sie - Tir tranquillisant !",
	fearsoon = "Fear imminent!",
	feartime = "Fear! 30 secondes avant le prochain!",
	fearbar = "Fear",
	...
	panic_desc = "Pr\195\169viens quand Magmadar lance sa peur de zone.",
