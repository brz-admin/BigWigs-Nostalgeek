...
L:RegisterTranslations("frFR", function() return {
	curse_trigger = "subit les effets de Mal\195\169diction de Gehennas.",
	--bolt_trigger = "Gehennas comienza a lanzar Descarga de las Sombras",
	rain_trigger = "Vous subissez les effets de Pluie de feu",
	rain_run_trigger = "Pluie de feu de ".. module.translatedName .." vous inflige (%d+) points de dégâts (.+).",
	curse_trigger2 = "Resistido Maldición de Gehennas de Gehennas",
	dead1 = "Attise-flammes meurt",
	addmsg = "%d/2 Attise-flammes morts!",
	flamewaker_name = "Attise-flammes",

	barNextRain = "Prochaine Pluie de feu",

	curse_warn_soon = "5 secondes avant Mal\195\169diction !",
	curse_warn_now = "Mal\195\169diction ! - Go décurse!!",

	curse_bar = "Mal\195\169diction de Gehennas",
	firewarn = "Bougez du Feu!",

	cmd = "Gehennas",

	--adds_cmd = "adds",
	adds_name = "Compteur d'Attise-flammes",
	adds_desc = "Annonce quand un Attise-flammes meurt",
	...
	--rain_cmd = "rain",
	rain_name = "Alerte de Pluie de feu",
	rain_desc = "Affiche un avertissement pour la Pluie de feu",
