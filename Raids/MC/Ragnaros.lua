...
L:RegisterTranslations("frFR", function() return {
	knockback_trigger = "^GOÛTEZ", -- /script PlaySoundFile("Sound\\Creature\\Ragnaros\\RagnarosSpecialAttack02.wav")
	submerge_trigger = "^VENEZ ! Ô MES SERVITEURS !", -- /script PlaySoundFile("Sound\\Creature\\Ragnaros\\RagnarosSpecialAttack03.wav")
	submerge_trigger2 = "^LES FILS DE LA FLAMME VIVANTE",
	engage_trigger = "^ET MAINTENANT",
	engage_soon_trigger1 = "Imprudents mortels!",
	engage_soon_trigger2 = "TROP TOT!",
	engage_soon_trigger3 = "CES INSECTES",
	hammer_trigger = "^PAR LE FEU", -- /script PlaySoundFile("Sound\\Creature\\Ragnaros\\RagnarosSpecialAttack01.wav")

	knockback_message = "Projection de zone !",
	knockback_soon_message = "Projection de zone imminente!",
	...
	submerge_30sec_message = "30 secondes avant l'arriv\195\169e des Fils des flammes !",
	submerge_10sec_message = "10 secondes avant l'arriv\195\169e des Fils des flammes !",
	submerge_5sec_message = "5 secondes avant l'arriv\195\169e des Fils des flammes !",
	...
	--start_cmd = "start",
	start_name = "Début",
	start_desc = "Montre une barre d'estimation de début du combat.",
	...
	--adds_cmd = "adds",
	adds_name = "Alerte mort des Fils",
	adds_desc = "Pr\195\169viens de la mort d'un Fils des flammes.",
