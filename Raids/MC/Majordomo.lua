...
L:RegisterTranslations("frFR", function() return {
	...
	engage_trigger = "Imprudents mortels ! Nuls ne peut défier les fils de la Flamme vivante !",

	magic_trigger = "gagne Renvoi de la magie",
	dmg_trigger = "gagne Bouclier de dégâts",
	magic_over_trigger = "Renvoi de la magie sur (.+) Attise%-flammes vient de se dissiper",
	damage_over_trigger = "Bouclier de d\195\169g\195\162ts sur (.+) Attise%-flammes vient de se dissiper",
	healdead = "Soigneur Attise-flammes meurt",
	elitedead = "Elite Attise-flammes meurt",
	elitename = "Elite Attise-flammes",
	healername = "Soigneur Attise-flammes",

	magic_warn = "Bouclier sorts pendant 10 secondes !",
	dmg_warn = "Bouclier d\195\169g\195\162ts pendant 10 secondes !",
	shield_warn_soon = "3 secondes avant nouveaux boucliers!",
	magic_over_warn = "Bouclier sorts termin\195\169 !",
	dmg_over_warn = "Bouclier d\195\169g\195\162ts termin\195\169 !",
	hdeadmsg = "%d/4 Soigneur Attise-flammes morts!",
	edeadmsg = "%d/4 Elite Attise-flammes morts!",

	magic_bar = "Renvoi de la magie",
	dmg_bar = "Bouclier de d\195\169g\195\162ts",
	shield_bar = "Nouveau Bouclier",

	--cmd = "Majordomo",

	--adds_cmd = "adds",
	adds_name = "Compteur d'adds",
	adds_desc = "Annonce quand un Soigneur ou un Elite Attise-flammes meurt",
