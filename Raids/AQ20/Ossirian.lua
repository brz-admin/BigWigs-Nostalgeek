...
L:RegisterTranslations("frFR", function() return {
	...
	crystaltrigger = "Cristal d'Ossiran",
	debuffwarn = "Ossirian est sensible %s!",
	supreme_bar = "Supr\195\170me",
	expose = "Exposer",

	["cyclone_trigger"] = "^([^%s]+) ([^%s]+) les effets de Linceul de vents%.$",
	["stomp_trigger"] = "Choc martial",

	["WarStomp"] = "Choc martial",
	["Cyclone"] = "Linceul sur %s",

	["Shadow"] = "à l'Ombre",
	["Fire"] = "au Feu",
	["Frost"] = "au Givre",
	["Nature"] = "\195\160 la Nature",
	["Arcane"] = "aux Arcanes",
