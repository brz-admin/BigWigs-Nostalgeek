...
L:RegisterTranslations("frFR", function() return {
	...
	--fear_cmd = "fear",
	fear_name = "Fear",
	fear_desc = "Prévien du Rugissement puissant",

	fear_trigger = "Rugissement puissant.",
	breath_trigger = "les effets de Souffle naus\195\169abond.",
	engage_trigger = "Peace is but a fleeting dream! Let the NIGHTMARE reign!",
	shades_trigger = "Children of Madness - I release you upon this world!",
	shadedies_trigger = "Ombre de Taerar meurt.",

	shades_warn = "Taerar est bannis! Tuer les Ombres!",
	fearCast_warn = "Fear dans 1.5 secondes!",
	breathSoon_warn = "Souffle naus\195\169abond bientôt!",
	breath_warn = "Souffle naus\195\169abond!",
	fear_warn = "AoE Fear Bientôt!",
	
	breath_bar = "Souffle naus\195\169abond",
	banish_bar = "Bannissement",
	fear_bar = "Rugissement puissant",
