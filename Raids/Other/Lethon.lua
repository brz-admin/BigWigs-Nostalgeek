...
L:RegisterTranslations("frFR", function() return {
	...
	--noxious_cmd = "noxious",
	noxious_name = "Alerte de Souffle nauséabond",
	noxious_desc = "Prévien du Souffle nauséabond",

	engage_trigger = "I can sense the SHADOW on your hearts. There can be no rest for the wicked!",
	breath_trigger = "les effets de Souffle nauséabond",
	shadow_trigger = "Your wicked souls shall feed my power!",

	shadow_warn = "Aparition des Ombres!",
	breathSoon_warn = "Souffle nauséabond bientôt!",
	breath_warn = "Souffle nauséabond!",


	breath_bar = "Souffle nauséabond",
