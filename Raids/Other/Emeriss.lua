...
L:RegisterTranslations("frFR", function() return {
	...
	volatileYou_warn = "Tu es infect\195\169 !",
	volatileOther_warn = " est infect\195\169 !",
	breathSoon_warn = "5 secondes avant le Souffle naus\195\169abond !",
	breath_warn = "Souffle naus\195\169abond - 30 secondes avant le suivant !",
	corruption_warn = "Corruption de la Terre! Go Heal!",

	isyou = "Vous",
	isare = "subissez",

	breath_bar = "Souffle naus\195\169abond",
	corruption_bar = "Corruption de la Terre",
