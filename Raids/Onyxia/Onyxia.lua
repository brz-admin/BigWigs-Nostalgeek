...
L:RegisterTranslations("frFR", function() return {
	--cmd = "Onyxia",
	engage_trigger = "pour me nourrir.",
	...
	--flamebreath_cmd = "flamebreath",
	flamebreath_name = "Alerte de Souffle de Flammes",
	flamebreath_desc = "Previen quand Onyxia commence a lancer Souffle de flammes",

	--wingbuffet_cmd = "wingbuffet",
	wingbuffet_name = "Frappe des ailes",
	wingbuffet_desc = "Prévien pour Frappe des ailes.",

	--fireball_cmd = "fireball",
	fireball_name = "Boule de Feu",
	fireball_desc = "Prévien des boules de feu.",
	...
	--onyfear_cmd = "onyfear",
	onyfear_name = "Fear",
	onyfear_desc = "Previen du Rugissement puissant en phase 3.",

	deepbreath_trigger = "%s prend une grande inspiration%.%.%.",
	flamebreath_trigger = "Onyxia commence à lancer Souffle de Flammes\.",
	wingbuffet_trigger = "Onyxia commence à lancer Frappe des ailes\.",
	fireball_trigger = "Onyxia commence à lancer Boule de feu.",
	phase2_trigger = "Cet exercice dénué de sens m'ennuie. Je vais vous incinérer d'un seul coup !",
	phase3_trigger = "On dirait que vous avez besoin d'une nouvelle leçon, mortels !",
	fear_trigger = "Onyxia commence à lancer Rugissement puissant.",
	fear_over_trigger = "Rugissement puissant",

	warn1 = "Souffle imminent!",
	phase1text = "Phase 1",
	phase2text = "Arriv\195\169e de la phase 2 !",
	phase3text = "Arriv\195\169e de la phase 3 !",
	feartext = "Peur de zone dans 3 secondes!",
	fear_cast = "Fear",
	fear_next = "Prochain fear",
	deepbreath_cast = "Grane Inspiration",
	flamebreath_cast = "Souffle de Flammes",
	wingbuffet_cast = "Frappe des ailes",
	fireball_cast = "Boule de Feu sur %s",
} end )
