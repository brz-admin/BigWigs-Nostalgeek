...
L:RegisterTranslations("frFR", function() return {
	...
	--lightningtotem_cmd = "lightningtotem",
	lightningtotem_name = "Alerte Totem de Foudre",
	lightningtotem_desc = "Prévien des totem de foudre",
	
	lightningtotem_trigger = "Monstruosité vivante commence à lancer Totem de foudre",
	lightningtotem_trigger2 = "Monstruosité vivante lance Totem de foudre.",
	lightningtotem_bar = "Totem de foudre",
	lightningtotem_message = "Totem de foudre arrive!",
} end )
---------------------------------
--      	Variables 		   --
---------------------------------
