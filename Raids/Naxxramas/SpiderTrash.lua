...
L:RegisterTranslations("frFR", function() return {
	...
	--charge_cmd = "charge",
	charge_name = "Charge empoisonnée",
	charge_desc = "Montre le CD et un icone pour la Charge empoisonnée.",
	
	charge_trigger = "subit les effets de Charge empoisonnée",
	chargeself_trigger = "Vous subissez les effets de Charge empoisonnée",
	chargegone_self = "Charge empoisonnée se dissipe de vous",
	charge_bar = "CD Charge empoisonnée",
} end )
