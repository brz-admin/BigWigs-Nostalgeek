...
L:RegisterTranslations("frFR", function() return {
	...
	frenzy_desc = "Prévien de la frénésie",

	--enrage_cmd = "enrage",
	enrage_name = "Alerte Enrager",
	enrage_desc = "previen de l'enrage",

	--decimate_cmd = "decimate",
	decimate_name = "Alerte de Décimer",
	decimate_desc = "Previen du décimer",

	frenzy_trigger = "%s gagne Fr\195\169n\195\169sie.",
	berserk_trigger = "gagne Enrager",
	fear_trigger = "de Rugissement terrifiant.",
	starttrigger = "d\195\169vore tous les zombies aux alentours !",

	frenzy_warn = "Alerte de Frénésie!",
	fear_warn_5 = "5 secondes avant le fear!",
	fear_warn = "Alert de Fear - 20 secondes avant le prochain!",

	enragewarn = "ENRAGER!",
	enragebartext = "Enrager",
	enrage_warn_90 = "Enrager dans 90 secondes",
	enrage_warn_30 = "Enrager dans 30 secondes",
	enrage_warn_10 = "Enrager dans 10 secondes",

	startwarn = "Gluth engagé! ~1:45 avant Décimer!",
	decimatesoonwarn = "Décimer bientôt!",
	decimatebar = "Décimer",

	--zombies_cmd = "zombies",
	zombies_name = "Zombies",
	zombies_desc = "Montre le timer des zombies",
	zombiebar = "Prochain Zombie - %d",

	bar1text = "Fear",

	testtrigger = "testtrigger";

	frenzygain_trigger = "Gluth gagne Fr\195\169n\195\169sie.",
	frenzygain_trigger2 = "Gluth entra frenzy!",
	frenzyend_trigger = "Fr\195\169n\195\169sie se dissipe",
	frenzy_message = "Frénésie! Tranqshot maintenant!",
	frenzy_bar = "Frénésie",
	frenzy_Nextbar = "Prochaine Frénésie",
} end )
