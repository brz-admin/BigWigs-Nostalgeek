...
L:RegisterTranslations("frFR", function() return {
	...
	--spray_cmd = "spray",
	spray_name = "Alerte de Jet de rets",
	spray_desc = "Prévien des Jet de rets",
	...
	--cocoon_cmd = "cocoon",
	cocoon_name = "Alerte de l'entoiler",
	cocoon_desc = "Alerte de l'entoiler",

	--poison_cmd = "Poison",
	poison_name = "Alerte de Poison nécrotique",
	poison_desc = "Prévien du Poison",

	cocoontrigger = "(.*) (.*) les effets de Entoilage.",
	webspraytrigger = "les effets de Jet de rets.",
	poisontrigger = "les effets de Poison nécrotique.",
	etrigger1 = "%s devient folle furieuse !",

	cocoonwarn = "%s est Entoilé!",
	poisonwarn = "Poison nécrotique!",
	enragetrigger = "%s devient folle furieuse !",

	webspraywarn30sec = "Entoilé dans 10 segundos",
	webspraywarn20sec = "Entoilé! 15 secondes avant les Araignées!",
	webspraywarn10sec = "10 secondes avant Jet de rets!",
	webspraywarn5sec = "AOE - Spawn araignées - AOE! JET DE RETS 5 SECONDES!",
	webspraywarn = "Jet de rets! 40 secondes avant le prochain!",

	enragewarn = "Enrager!",
	enragesoonwarn = "Enrager bientôt!",

	webspraybar = "Jet de rets",
	cocoonbar = "Entoiler",
	spiderbar = "Araignées",
	poisonbar = "Poison nécrotique",
