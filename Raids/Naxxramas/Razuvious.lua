...
L:RegisterTranslations("frFR", function() return {
	...
	--shout_cmd = "shout",
	shout_name = "Alerte de Cri perturbant",
	shout_desc = "Prévien du Cri perturbant",

	--unbalance_cmd = "unbalancing",
	unbalance_name = "Alerte de Frappe déséquilibrante",
	unbalance_desc = "Prévien de la Frappe déséquilibrante",

	--shieldwall_cmd = "shieldwall",
	shieldwall_name = "Timer de Mur Protecteur",
	shieldwall_desc = "Montre le timer pour le mur prot",

	startwarn = "Instructeur Razuvious engagé! 25 secondes avant le Cri, 30 secondes avant la Frappe déséquilibrante!",

	starttrigger1 = "Les cours sont termin\195\169s ! Montrez-moi ce que vous avez appris !",
	starttrigger2 = "Faites ce que vous ai appris !",
	starttrigger3 = "Pas de quartier !",
	starttrigger4 = "Frappe-le \195\160 la jambe",

	shouttrigger = "Cri perturbant",
	shouttrigger2 = "Cri perturbant",
	shout7secwarn = "7 secondes avant Cri perturbant",
	shout3secwarn = "3 secondes Cri perturbant!",
	shoutwarn = "Cri perturbant! Prochain dans 25 secondes",
	noshoutwarn = "Pas de Cri! Prochain dans 20 secondes",
	shoutbar = "Cri perturbant",

	unbalance_trigger = "les effets de Frappe déséquilibrante.",
	unbalancesoonwarn = "Frappe déséquilibrante bientôt!",
	unbalancewarn = "Frappe déséquilibrante! Prochaine dans ~30 secondes",
	unbalancebar = "Frappe déséquilibrante",

	shieldwalltrigger   = "Doublure de chevalier de la mort gagne Mur protecteur.",
	shieldwallbar       = "Mur protecteur",
} end )
