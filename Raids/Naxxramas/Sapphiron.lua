...
L:RegisterTranslations("frFR", function() return {
	...
	--deepbreath_cmd = "deepbreath",
	deepbreath_name = "Alerte de Souffle de givre",
	deepbreath_desc = "Prévien du Souffle de givre",

	--lifedrain_cmd = "lifedrain",
	lifedrain_name = "Drain de vie",
	lifedrain_desc = "Prévien du Drain de vie",

	--berserk_cmd = "berserk",
	berserk_name = "Enrage",
	berserk_desc = "Prévien de l'enrage",

	--icebolt_cmd = "icebolt",
	icebolt_name = "Annonces Bloc de glace",
	icebolt_desc = "cri quand vous avez un Bloc de glace.",

	berserk_bar = "Enrager",
	berserk_warn_10min = "10 minutes avant Enrage!",
	berserk_warn_5min = "5 minutes avant Enrage!",
	berserk_warn_rest = "%s secondes avant Enrage!",

	engage_message = "Sapphiron engagé! Enrager dans 15 minutes!",

	lifedrain_message = "Drain de vie! Prochain possible dans ~24 secondes!",
	lifedrain_warn1 = "Drain de vie dans 5 secondes!",
	lifedrain_bar = "Drain de vie",

	lifedrain_trigger = "les effets de Drain de vie.",
	lifedrain_trigger2 = " Drain de vie",
	icebolt_trigger = " effets de Eclair de glace.",

	deepbreath_incoming_message = "Souffle de givre dans ~23 secondes!",
	deepbreath_incoming_soon_message = "Souffle de givre dans ~5 secondes!",
	deepbreath_incoming_bar = "Souffle de givre",
	deepbreath_trigger = "%s prend une grande inspiration...",
	deepbreath_warning = "Souffle de givre bientôt!",
	deepbreath_bar = "Souffle de givre!",
	icebolt_yell = "Je suis un Block de glace!",
} end )
