...
L:RegisterTranslations("frFR", function() return {
	...
	--blink_cmd = "blink",
	blink_name = "Alerte de Transfert",
	blink_desc = "Préviens du transfert",

	--teleport_cmd = "teleport",
	teleport_name = "Alerte de Téléportation",
	teleport_desc = "prévien quand Noth va se téléporter",

	--curse_cmd = "curse",
	curse_name = "Alerte de Malédiction",
	curse_desc = "Prévien de la Malédiction",

	--wave_cmd = "wave",
	wave_name = "Alerte des Adds",
	wave_desc = "Prévien de l'arrivée des Adds",

	starttrigger1 = "Mourez intrus !",
	starttrigger2 = "Gloire au ma\195\174tre !",
	starttrigger3 = "Vos vies ne valent plus rien !",
	startwarn = "Noth le Porte-peste engagé! 90 secondes avant Téléportation",

	addtrigger = "Levez vous, soldats ! Levez vous et combattez une fois encore !",

	blinktrigger = "Noth le Porte-peste gagne Transfert.",
	blinkwarn = "Transfert!",
	blinkwarn5 = "Transfert dans ~5 secondes!",
	blinkwarn10 = "Transfert dans ~10 secondes!",
	blinkbar = "Transfert Possible",

	teleportToBalconyTrigger = "Noth le Porte-peste se téléporte sur le balcon!",
	teleportToRoomTrigger = " la bataille!",
	teleportwarn = "Téléportation sur le Balcon!",
	teleportwarn10 = "Téléportation dans 10 secondes!",
	teleportwarn30 = "Téléportation en 30 secondes!",

	teleportbar = "Téléportation!",
	backbar = "Retour de Noth!",

	backwarn = "Retour de Noth pour %d secondes!",
	backwarn10 = "10 secondes avant le retour de Noth!",
	backwarn30 = "30 secondes avant le retour de Noth!",

	cursetrigger = "les effets de Malédiction du Porte-peste.",
	cursewarn = "Malédictions! Go Décurse!! Prochaine dans ~28 secondes",
	curse10secwarn = "Malédiction dans ~10 secondes",

	cursebar = "Prochaine Malédiction",

	wave1bar = "Vague 1",
	wave2bar = "Vague 2",
	wave2_message = "Vague 2 dans 10 secondes",
	wave2s_message = "La Vague 2 arrive!",
} end )
