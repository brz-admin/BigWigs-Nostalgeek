...
L:RegisterTranslations("frFR", function() return {
	...
	--room_cmd = "room",
	room_name = "Alerte de l'arrivée",
	room_desc = "Prévien de l'arrivée de Gothik",

	--add_cmd = "add",
	add_name = "Alerte des Adds",
	add_desc = "Prévien pour les Adds",

	--adddeath_cmd = "adddeath",
	adddeath_name = "Alerte de la Mort des Adds",
	adddeath_desc = "prévien quand un add meurt.",

	disabletrigger = "C'est... ma... fin.",

	starttrigger1 = "Dans votre folie, vous avez provoqué votre propre mort.",
	starttrigger2 = "Teamanare shi rikk mannor rikk lok karkun",
	startwarn = "Gothik le moissonneur engag\195\169! 4:35 avant son arriv\195\169e dans la salle.",
	...
	warn_inroom_3m = "Dans la salle dans 3 minutes",
	warn_inroom_90 = "Dans la salle dans 90 secondes",
	warn_inroom_60 = "Dans la salle dans 60 secondes",
	warn_inroom_30 = "Dans la salle dans 30 secondes",
	warn_inroom_10 = "Gothik arrive dans 10 secondes",
	...
	inroomwarn = "Gothik est dans la salle !",
