...
L:RegisterTranslations("enUS", function() return {
	...
	soundshadowpot = "Interface\\AddOns\\BigWigs_NG\\Sounds\\potion.wav",
	soundbandage = "Interface\\AddOns\\BigWigs_NG\\Sounds\\bandage.wav",
	soundwrtorhs = "Interface\\AddOns\\BigWigs_NG\\Sounds\\healthstone.wav",
	soundshadowpotandbandage = "Interface\\AddOns\\BigWigs_NG\\Sounds\\potionandbandage.wav",
	soundgoforbuff = "Interface\\AddOns\\BigWigs_NG\\Sounds\\goforbuff.wav",
...
L:RegisterTranslations("frFR", function() return {
	...
	--doom_cmd = "doom",
	doom_name = "Alerte de Malédiction inévitable",
	doom_desc = "Prévien de la Malédiction inévitable",

	--curse_cmd = "curse",
	curse_name = "Alerte de Malédictions dissipées",
	curse_desc = "Prévien quand les Malédictions sont dissipées de Loatheb",

	--spore_cmd = "spore",
	spore_name = "Alerte de Spores",
	spore_desc = "Prévien pour les Spores",

	--debuff_cmd = "debuff",
	debuff_name = "Debuff de Spores",
	debuff_desc = "Afficher l'icône lorsque votre debuff de spores est épuisé",

	--groups_cmd = "groups",
	groups_name = "Groupes de Spores",
	groups_desc = "Désactive l'affichage des groupe pour les spores (Tactique de 7 groupes)",


	doombar = "Malédiction inévitable %d",
	doomwarn = "Malédiction inévitable %d! suivante dans %d secondes!",
	doomwarn5sec = "Malédiction inévitable %d dans 5 sec!",
	doomtrigger = "les effets de Mal\195\169diction in\195\169vitable.",

	cursewarn = "Malédictions dissipées! RENOUVELLEZ-LES!",
	cursebar = "Dissipation Malédiction",
	--cursetrigger = "Loatheb's Chains of Ice is removed.",
	cursetrigger  = "Malédiction de Horreb (.+) se dissipe.",
	...
	cursetimerbar = "Timer Malédictions dissipées",
	cursetimerwarn = "Malédictions dissipées, prochaine dans %s secondes!",
	...
	graphic_desc = "Affiche les icônes graphiques lorsque coché",

	--sound_cmd = "sound",
	sound_name = "Activez les effets sonores",
	sound_desc = "Joue les sons quand c'est coché",

	doomtrigger = "les effets de Mal\195\169diction in\195\169vitable.",

	--consumable_cmd = "consumable",
	consumable_name = "Ne pas aviser le raid pour les consomables (A)",
	consumable_desc = "Quand coché, ne previen pas le raid de quand utilisé tel consos. Requiers Promote (A)",

	shadowpot = "-- Buvez une Potion de protection contre l'ombre supérieure ! --",
