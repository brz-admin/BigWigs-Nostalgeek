...
L:RegisterTranslations("frFR", function() return {
	...
	--enrage_cmd = "enrage",
	enrage_name = "Alerte Enrager sur Add",
	enrage_desc = "Prévien quand un Gardien de la crypte passe en enragé",

	starttrigger1 = "Rien qu'une petite bouch\195\169e...",
	starttrigger2 = "Oui, courez ! Faites circuler le sang !", -- singula?
	starttrigger3 = "Nul part pour s'enfuir.",

	etrigger = "gagna Enrager.",
	enragewarn = "Gardien de la crypte enrage! - Stun + Traps!",
	...
	gainincbar = "Prochaine Nuée possible",
	...
	--impale_cmd = "impale",
	impale_name = "Alerte de Empaler",
	impale_desc = "Prévien pour l'Empaler",
	impaletrigger = "Anub'Rekhan commence à lancer Empaler", -- todo
	impalebar = "Prochain Empaler",
	impalesay = "Empaler sur moi!",
