...
L:RegisterTranslations("frFR", function() return {
	...
	--mark_cmd = "mark",
	mark_name = "Alerte des Marques",
	mark_desc = "Prévien pour les marques",

	--shieldwall_cmd  = "shieldwall",
	shieldwall_name = "Alerte de Mur protecteur",
	shieldwall_desc = "Prévien du mur prot",

	--void_cmd = "void",
	void_name = "Alerte de Zone du vide",
	void_desc = "Prévien quand Lady Blaumeux lance Zone du vide.",

	--meteor_cmd = "meteor",
	meteor_name = "Alerte de Météore",
	meteor_desc = "Prévien quand Thane lance Météore.",

	--wrath_cmd = "wrath",
	wrath_name = "Alerte de Colère divine",
	wrath_desc = "Prévien quand Zeliek lance Colère divine.",

	markbar = "Marque %d",
	mark_warn = "Marque %d!",
	mark_warn_5 = "Marque %d dans 5 sec",
	marktrigger1 = "les effets de Marque de Zeliek",
	marktrigger2 = "les effets de Marque de Korth'azz",
	...
	shieldwall_warn = "%s - Mur Protecteur pendant 20 sec",
	shieldwall_warn_over = "%s - Mur Protecteur FINI!",
} end )
