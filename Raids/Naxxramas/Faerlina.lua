...
L:RegisterTranslations("frFR", function() return {
	...
	--silence_cmd = "silence",
	silence_name = "Alerte du Silence",
	silence_desc = "Prévien du Silence",

	--enrage_cmd = "enrage",
	enrage_name = "Alerte Enrager",
	enrage_desc = "Prévien de l'enragé",
	...
	startwarn = "Grande veuve Faerlina engagé, 60 secondes avant Enrager!",
	enragewarn15sec = "15 secondes avant Enrage!",
	enragewarn = "Enrager!",
	enrageremovewarn = "Enrager dissipé! %d secondes avant le prochain!", -- added
	silencewarn = "Silence! Retarder Enrage!",
	silencewarnnodelay = "Silence!",
	silencewarn5sec = "Silence disparait dans 5 secondes",
	...
	rain_desc = "Vous prévien si vous êtes dans la Pluie de feu",
	rain_trigger = "Vous subissez les effet de Pluie de feu",
	rain_run_trigger = "Vous subissez (%d+) (.+) de Pluie de feu",
	rain_warn = "Bougez du Feu!",
} end )
