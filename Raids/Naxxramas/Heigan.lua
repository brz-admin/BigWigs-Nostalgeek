...
L:RegisterTranslations("frFR", function() return {
	...
	teleport_desc = "Prévien de la Téléportation.",

	--engage_cmd = "engage",
	engage_name = "Alerte de Enrager",
	engage_desc = "Prévien quand Heigan est Enragé.",

	--disease_cmd = "disease",
	disease_name = "Alert de Fièvre de décrépitude",
	disease_desc = "Prévien de la Fièvre de décrépitude",

	--erruption_cmd = "erruption",
	erruption_name = "Alerte des Erruptions",
	erruption_desc = "Prévien des Erruptions",
	...
	toPlatform_trigger1 = "teleports and begins to channel a spell!",
	toPlatform_trigger2 = "Votre fin est venue.",
	toFloor_trigger = "rushes to attack once more!",
	die_trigger = "Noo... on...",
	dtrigger = "les effets de Fièvre de décrépitude.",

	-- [[ Warnings ]]--
	engage_message = "Heigan l'Impur engagé! 90 sec avant la Téléportation",

	dwarn = "Fièvre de décrépitude",

	on_platform_message = "Téléportation! dancez pendant %d secondes!",

	to_floor_30sec_message = "Retour dans 30 sec",
	to_floor_10sec_message = "Retour dans 10 sec!",
	on_floor_message = "Phase Tanking!! 90 secondes avant la prochaine Téléportation!",

	-- [[ Bars ]]--
	toPlatform_bar = "Téléportation!",
	toFloor_bar = "Retour sur la piste!",
	dbar = "Fièvre de décrépitude",
	erruptionbar = "Erruption",
	dancingshoes = "Mettez vos chaussures de danse!",
