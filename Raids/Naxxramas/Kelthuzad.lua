...
L:RegisterTranslations("frFR", function() return {
	...
	phase_desc = "Alerte lors des changements de phase.",

	--mc_cmd = "mindcontrol",
	mc_name = "Alerte Contrôle Mental",
	mc_desc = "Alerte quand des joueurs se font contrôle mental.",

	--fissure_cmd = "fissure",
	fissure_name = "Alerte Fissure d'ombre",
	fissure_desc = "Alerte des prochaines Fissure d'ombre.",

	--frostblast_cmd = "frostblast",
	frostblast_name = "Alerte Trait de givre",
	frostblast_desc = "Alerte des prochains Trait de givre.",

	--frostbolt_cmd = "frostbolt",
	frostbolt_name = "Alerte de Eclair de givre",
	frostbolt_desc = "previen pour les Eclair de givre",

	frostboltbar_cmd = "frostboltbar",
	frostboltbar_name = "Barre Eclair de givre",
	frostboltbar_desc = "Montre une barre pour les Eclair de givre",

	--detonate_cmd = "detonate",
	detonate_name = "Alerte détoner le mana",
	detonate_desc = "Alerte des détonation de mana.",

	--detonateicon_cmd = "detonateicon",
	detonateicon_name = "Icône détoner le mana",
	detonateicon_desc = "Place une icône sur les joueurs affecté par détoner le mana.",

	--guardians_cmd = "guardians",
	guardians_name = "Arrivé des Gardiens",
	guardians_desc = "Alerte l'arrivée des gardiens de la citadelle en P3.",

	--fbvolley_cmd = "fbvolley",
	fbvolley_name = "Vollée d'Eclair de givre Possible",
	fbvolley_desc = "Timer pour une possible Vollée d'Eclair de givre.",
	...
	kick_trigger1 = "Coup de pied touche Kel'Thuzad",
	kick_trigger2 = "Kick crits Kel'Thuzad",
	kick_trigger3 = "Kick was blocked by Kel'Thuzad",
	pummel_trigger1 = "Pummel hits Kel'Thuzad",
	pummel_trigger2 = "Pummel crits Kel'Thuzad",
	...
	phase1_warn = "Phase 1 se termine dans 20 secondes!",
	...
	frostbolt_trigger = "Kel'Thuzad commence à lancer Eclair de givre.",
	frostbolt_warning = "Eclair de givre! Go Kick!",
	frostbolt_bar = "Eclair de givre",

	frostbolt_volley = "Vollée Possible",
	frostbolt_volley_trigger = "effets de Eclair de givre.",

	add_dead_trigger = "(.*) meurt",
	add_bar = "%d/14 %s",
	...
	phase2_frostblast_warning = "Trait de givre Possible dans ~5secondes!",
	phase2_mc_warning = "Contrôle Mental possible dans ~5 secondes!",
	phase2_detonate_warning = "Détoner Mana dans ~5 secondes!",

	detonate_trigger = "^([^%s]+) ([^%s]+) les effets de Faire détoner mana",
	detonate_bar = "Détoner Mana - %s",
	detonate_possible_bar = "Détoner mana probable",
	detonate_warning = "%s a détoner le Mana!",
