...
L:RegisterTranslations("enUS", function() return {
	...
	addsdownwarn = "Thaddius incoming in 18sec!",
...
L:RegisterTranslations("frFR", function() return {
	...
	--polarity_cmd = "polarity",
	polarity_name = "Alerte de Changement de polarité",
	polarity_desc = "Prévien du de Changement de polarité",

	--power_cmd = "power",
	power_name = "Alerte de Vague de puissance",
	power_desc = "Prévien de la Vague de puissance de Stalagg",

	--adddeath_cmd = "adddeath",
	adddeath_name = "Alerte de la Mort des Adds",
	adddeath_desc = "Previen quand un add meurt",

	--charge_cmd = "charge",
	charge_name = "Alerte de Polarité",
	charge_desc = "Prévien du changement de polarité sur vous-même (positive/negative).",

	--throw_cmd = "throw",
	throw_name = "Alerte de Lancer",
	throw_desc = "prévien du changement de plateforme pour les tanks.",
	...
	adddeath = "No... more... Feugen...",
	adddeath2 = "Maître sauver moi...",

	teslaoverload = "%s overloads!",

	pstrigger = "Maintenant TOI sentir douleur !",
	trigger_polarity_cast = "Thaddius commence à lancer Changement de polarité.",
	...
	enragewarn = "Enrager!",
	startwarn = "Thaddius Phase 1",
	startwarn2 = "Thaddius Phase 2, Enrager dans 5 minutes!",
	addsdownwarn = "Thaddius arrive dans 18 secondes!",
	pswarn1 = "Thaddius commence à lancer Changement de polarité! - REGARDEZ VOS DEBUFFS!",
	pswarn2 = "30 secondes avant Changement de polarité!",
	pswarn3 = "¡3 secondes avant Changement de polarité!",
	poswarn = "Changement - Vous êtes en Polarité Positive!",
	negwarn = "Changement - Vous êtes en Polarité Négative!",
	nochange = "Votre polarité n'a pas changé!",
	polaritytickbar = "Tic de Polarité",
	enragebartext = "Enrager",
	warn_enrage_3m = "Enrager dans 3 minutes",
	warn_enrage_90 = "Enrager dans 90 secondes",
	warn_enrage_60 = "Enrager dans 60 secondes",
	warn_enrage_30 = "Enrager dans 30 secondes",
	warn_enrage_10 = "Enrager dans 10 secondes",
	...
	throwbar = "Lancer",
	throwwarn = "Lancer de tanks dans ~5 secondes!",
...
L:RegisterTranslations("esES", function() return {
	...
	addsdownwarn = "¡Thaddius entrante en 18 segundos!",
