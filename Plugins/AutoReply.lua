...
L:RegisterTranslations("frFR", function() return {
		...
		--statusRequest_cmd = "statusRequest",
		statusRequest_name = "Etat du boss",
		statusRequest_desc = "Permet la requête de l'etat du boss",

		--healthStatus_cmd = "healthStatus",
		healthStatus_name = "Etat des HP",
		healthStatus_desc = "Permet aux joueur de savoir l'etat des HP du boss en cours",

		--playersAlive_cmd = "playersAlive",
		playersAlive_name = "Etat des joueurs",
		playersAlive_desc = "Permet aux joueur de savoir combien de membres du raid sont en vie",
