...
L:RegisterTranslations("frFR", function() return {
	...
	["Gives timer for Scorch Fire Vulnerability."] = "Affiche le timer des brulures",
	["Enable"] = "Activé",
	["Enable timers."] = "Active les timers",
	["Target only"] = "Cible seulement",
	["Only show timer for the current target."] = "Montre le timer de la cible actuelle seulement",
	["Show the bar anchor frame."] = "Montre l'ancre de la barre",
	["Set the bar scale."] = "Ajuste la taille de la barre",
	["Group upwards"] = "Grouper en haut",
	["Toggle bars grow upwards/downwards from anchor."] = "Alterne entre l'affichage en haut et en bas de l'ancre",

	["Timer bars"] = "Barres de timer",
	["Show anchor"] = "Montrer l'ancre",
	["Grow bars upwards"] = "Grouper les barres en haut",
	["Scale"] = "Taille",
	["Bar scale"] = "Taille des barres",

	["Bars now grow %2$s"] = "Les barres s'affiche maintenant en %2$s de l'ancre",
	...
	["Texture"] = "Texture",
	["Set the texture for the timerbars."] = "Definie la texture des barres de timer",

	["Reset position"] = "Raz de la position",
	["Reset the anchor position, moving it to the center of your screen."] = "Retablie la position de l'ancre au milieu de l'écran",
	["Reverse"] = "Inverser",
	["Toggles if bars are reversed (fill up instead of emptying)."] = "Alterne entre inversé et normal (remplir au lieu de vider.)",

	--["ScorchTimer"] = true,

	["Scorch Timer"] = "Timer de Brulure",

	firevuln_test = "(.+) est affecté par Vulnérabilité au Feu.",
	scorch_test	= "Votre Brûlure ",
	resist_test = "Vous utilisez Brûlure, mais ",
} end)
