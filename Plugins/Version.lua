...
L:RegisterTranslations("enUS", function() return {
	...
	["Your version of Big Wigs NostalGeek is out of date!\nPlease ask Lylat to get the latest version."] = true,
	["Close"] = true,
	["Cancel"] = true,
	...
	["Ask Lylat to get the latest version."] = true,
...
L:RegisterTranslations("frFR", function() return {
	...
	["Commands for querying the raid for Big Wigs versions."] = "Envoie une requête de vérification des versions",
	...
	["Nr Replies"] = "Pas de réponse",
	["Ancient"] = "Ancien",

	["Your version of Big Wigs NostalGeek is out of date!\nPlease ask Lylat to get the latest version."] = "Votre version de BigWigs NostalGeek n'est pas à jour!\n Demandez à Lylat pour avoir la dernière version.",
	["Close"] = "Fermer",
	["Cancel"] = "Annuler",

	["People with outdated BigWigs:"] = "Joueurs avec une version pas à jour:",
	["Notify old versions"] = "Notifier les anciennes versions",
	["List people with old versions to raid chat."] = "Liste les personnes avec des versions obselètes dans le chat raid",
	["Ask Lylat to get the latest version."] = "Demander à Lylat pour avoir la dernière version",

	["Show popup"] = "Montrer le popup",
	["Show popup warning on out of date version"] = "Montre une fenêtre popup si une version n'est pas à jour",
...
L:RegisterTranslations("esES", function() return {
	...
	["Your version of Big Wigs NostalGeek is out of date!\nPlease ask Lylat to get the latest version."] = "¡Tu versión de Big Wigs es anticuada!\n Por favor pide a Lylat que obtenga la última versión.",
	["Close"] = "Cerrar",
	["Cancel"] = "Cancelar",
	...
	["Ask Lylat to get the latest version."] = "Pide a Lylat que obtenga la última versión.",
...
L:RegisterTranslations("deDE", function() return {
	...
	["Your version of Big Wigs NostalGeek is out of date!\nPlease ask Lylat to get the latest version."] = "Deine Version von Big Wigs Elysium ist veraltet! Bitten Sie Lylat, die neueste Version.",
	["Close"] = "Schliessen",
	["Cancel"] = "Abbrechen",
} end )
...
function BigWigsVersionQuery:IsOutOfDate()
	if not self.OutOfDateShown then
		...
		BigWigs:Print(L["Your version of Big Wigs NostalGeek is out of date!\nPlease ask Lylat to get the latest version."])

		if self.db.profile.popup then
			local dialog = nil
			StaticPopupDialogs["BigWigsOutOfDateDialog"] = {
				text = L["Your version of Big Wigs NostalGeek is out of date!\nPlease ask Lylat to get the latest version."],
				button1 = L["Close"],
				button2 = L["Cancel"],
				OnAccept = function()
...
function BigWigsVersionQuery:NotifyOldVersions()
	...
	SendChatMessage(L["Ask Lylat to get the latest version."], "RAID")
end
