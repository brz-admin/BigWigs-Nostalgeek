...
L:RegisterTranslations("frFR", function() return {
	...
	["OMG Bear!"] = "OMG un Ours!",
	["*RAWR*"] = "*GRRR*",
	["Victory!"] = "Victoire!",
	["Options for testing."] = "Options des tests",
	["local"] = "locale",
	["Local test"] = "Test local",
	["Perform a local test of BigWigs."] = "Fait un test local de BigWigs",
	["sync"] = "syncronisation",
	["Sync test"] = "Test de syncronisation",
	["Perform a sync test of BigWigs."] = "Fait un test de syncronisation de BigWigs",
	["Testing Sync"] = "Test de syncronisation",
} end)
