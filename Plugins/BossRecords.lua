...
L:RegisterTranslations("frFR", function() return {
	BOSS_ENGAGED    = "%s engagé. Bonne chance! :)",
	BOSS_DOWN		= "%s à été vaincu en %s!",
	BOSS_DOWN_L		= "%s à été vaincu en %s! Votre dernier kill avait pris %s et votre plus rapide était de %s. Vous cummulez un total de %d victoires.",
	BOSS_DOWN_NR	= "%s à été vaincu en %s! C'est un nouveau record! (Ancien record: %s). Vous cummulez un total de %d victoires.",
} end)
