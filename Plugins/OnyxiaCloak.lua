...
L:RegisterTranslations("frFR", function() return {
    ["Onyxia Scale Cloak"] = "Cape d'Onyxia", -- plugin name
    --["onyxiaCloak"] = true, -- console command
    ["Equips Onyxia Scale Cloak when you enter Nefarians Lair and switches back when you leave the area again."] = "Equipe la Cape d'Onyxia quand vous entrer dans l'antre de Nefarian et l'enleve quand vous le quittez.",
    ["Active"] = "Activé", -- option name
    ["Activate the plugin."] = "Active le Plugin.", -- option description
	["Onyxia Scale Cloak"] = "Cape en écailles d'Onyxia", -- item name
	["Could not find %s"] = "%s introuvable",
	["Equipping %s"] = "%s est equipée", 
	trigger_engage = "Dans ce monde où le temps est votre ennemi, c'est mon plus grand allié.", -- nefarian yell before the fight starts
	["Nefarians Lair"] = "Antre de Nefarian",
} end)
