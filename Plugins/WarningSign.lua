...
L:RegisterTranslations("frFR", function() return {
	--["WarningSign"] = true, -- console cmd
	["Warning Sign"] = "Signal d'Avertissement", -- module name
	["Options for the Warning Sign."] = "Options pour le signal d'avertissement",
	["Show anchor"] = "Montrer l'ancre",
	["Show the anchor frame."] = "Montre la fenêtre de l'ancre",
	["Reset"] = "Rétablir",
	["Reset the frame."] = "Rétabli la fenêtre",
	["Test"] = "Test",
	["Close"] = "Fermer",

	["Disabled"] = "Desactivé",
	["Disable the warning signs for all modules that use it."] = "Désactive les signaux d'avertissement pour tout les modules",
	["Scale"] = "Taille",
	["Set the warning sign scale."] = "Definie la taille du signal d'avertissement",
	["Transparency"] = "Transparence",
	["Set the warning sign alpha value (0.1 to 1.0: transparent to opaque)."] = "Definie la valeur de l'opacité du signal d'avertissement (0.1 a 1.0: transparent à opaque",
} end)
