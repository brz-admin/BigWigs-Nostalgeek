...
L:RegisterTranslations("frFR", function() return {
	["Zombie Food"] = "Etourdissement",
	--["zombiefood"] = true,
	["Optionally broadcast the raid when someone gets Dazed."] = "Prévien le raid quand quelqu'un est étourdit",
	--["broadcast"] = true,
	["Broadcast"] = "Transmettre",
	["Toggle broadcasting."] = "Transmet ou non les etourdissement au raid",
	["On"] = "Activé",
	--["on"] = true,
	["Toggles the plugin on and off."] = "Active ou désactive le plugin",

	["%s has been Dazed!"] = "¡%s est Etourdi!",
	["Dazed"] = "Etourdi",
} end )
