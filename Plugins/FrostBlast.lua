...
L:RegisterTranslations("frFR", function() return {
	...
	["Options for the Frost Blast frame."] = "Options de la fenêtre pour le Trait de givre.",
	["Lock frame"] = "Bloquer la fenêtre",
	["Lock the frost blast frame."] = "Bloque la fenêtre pour le Trait de givre",

	["Disabled"] = "Desactivé",
	["Disable the frost blast display."] = "Désactive la fenêtre du Trait de givre",

	font = "Fonts\\FRIZQT__.TTF",

	["Color Names"] = "Nom en couleur",
	["Class colored names."] = "Nom par couleur de classes",
	["Color Bars"] = "Barres de Couleur",
	["Class colored bars."] = "Barres par couleur de classes",

	["Test"] = "Test",
	["Perform a Frost Blast test."] = "Fait un test de Trait de givre",

	["Reset position"] = "Raz de la position",
	["Reset the anchor position, moving it to the center of your screen."] = "Retablis la position de l'encre et la déplace au mileu de l'écran.",
