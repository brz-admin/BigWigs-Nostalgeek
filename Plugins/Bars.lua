...
L:RegisterTranslations("frFR", function() return {
	...
	["Timer bars"] = "Barres de Timer",
	["Show anchor"] = "Afficher l'ancre",
	["Grow bars upwards"] = "Ajoutes les barres vers le haut",
	["Scale"] = "Taille",
	["Bar scale"] = "Taille des barres",

	["Bars now grow %2$s"] = "Les barres seront maintenant ajouté vers le %2$s",
	["Scale is set to %2$s"] = "La taille est maintenant définie à: %2$s",
	...
	["Texture"] = "Texture",
	["Set the texture for the timerbars."] = "Définie la texture des barres.",




	["Reset position"] = "Raz de la position",
	["Reset the anchor position, moving it to the center of your screen."] = "Rétabli la position de l'ancre et l'affiche au centre de l'écran.",
	["Reverse"] = "Inverser",
	["Toggles if bars are reversed (fill up instead of emptying)."] = "Bascule si les barres sont inversées (remplir au lieu de vider).",
	["Emphasize"] = "Surbrillance",
	["Emphasize bars that are close to completion (<10sec). Also note that bars started at less than 15 seconds initially will be emphasized right away."] = "Mettez en surbrillance les barres qui sont presque terminées (<10 secondes). Notez également que les barres commencées à moins de 15 secondes seront initialement accentuées tout de suite.",
	["Enable"] = "Activé",
	["Enables emphasizing bars."] = "Active les barres en surbrillance.",
	["Flash"] = "Flash",
	["Flashes the background red for bars that are emphasized."] = "Fait clignotter le fond en rouge pour les barres en surbillance.",
	["Move"] = "Bouger",
	["Move bars that are emphasized to a second anchor."] = "Bouge les barres en surbrillance à la deuxième ancre.",
	["Set the scale for emphasized bars."] = "Defini la taille des barres en surbrillance.",
	["Emphasize Bars"] = "Barres en surbrillance",
} end)
