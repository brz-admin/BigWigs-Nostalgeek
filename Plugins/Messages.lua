...
L:RegisterTranslations("frFR", function() return {
	...
	["Options for the message frame."] = "Options pour la disposition des messages",
	["Anchor"] = "Ancre",
	["Show the message anchor frame."] = "Montre l'ancre de placement des messages",
	["Use RaidWarning"] = "Utiliser les avertissements Raid",
	["Toggle sending messages to the RaidWarnings frame."] = "Basculer l'envoi de messages vers le cadre Avertissements Raid.",
	["Use colors"] = "Uiliser des couleurs",
	["Toggles white only messages ignoring coloring."] = "Bascule les messages en blancs uniquement en ignorant la coloration.",
	["Message frame scale"] = "Taille de la fenêtre des messages",

	["Message frame"] = "Fenêtre des messages",
	["Show anchor"] = "Montrer l'ancre",
	["Send messages to RaidWarning frame"] = "Envoyer les messages par l'avertissement Raid",
	["Set the message frame scale."] = "Definie la taille des messages",
	["Colorize messages"] = "Coloriser les messages",
	["Scale"] = "Taille",
