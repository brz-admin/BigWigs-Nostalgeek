...
L:RegisterTranslations("frFR", function() return {
	["Proximity"] = "Proximité",
	["Close Players"] = "Joueurs proche",
	["Options for the Proximity Display."] = "Options pour la fenêtre de proximité",
	["|cff777777Nobody|r"] = "|cff777777Personne|r",
	["Lock frame"] = "Bloquer la fenêtre",
	["Lock the proximity frame."] = "Bloque la fenêtre de proximité",
	["Sound"] = "Son",
	["Play sound on proximity."] = "joue un son si un joueur est trop proche",
	["Disabled"] = "Desactivé",
	["Disable the proximity display for all modules that use it."] = "Desactive la fenêtre de proximité pour tout les modules l'utilisant",
	["The proximity display has been disabled for %s, please use the boss modules options to enable it again."] = "La fenêtre de proximité à été désactivé pour %s, utilisez les options de module de boss pour la réactiver",

	["Has Debuff"] = "A le Debuff",

	proximity = "Affichage de proximité",
	proximity_desc = "Montre la fenêtre de proximité quand cela est approprié, regarde les joueurs trop proche de vous.",

	font = "Fonts\\FRIZQT__.TTF",

	["Test"] = "Test",
	["Perform a Proximity test."] = "Fait un test de proximité",
