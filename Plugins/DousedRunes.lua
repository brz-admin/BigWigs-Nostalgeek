...
L:RegisterTranslations("frFR", function() return {
    ["DousedRunes"] = "RunesMC",
	["Doused Runes"] = "Runes éteinte à MC",
	["Disabled"] = "Désactivé",
    ["Options for the doused runes Display."] = "Options d'affichages",
    ["Show frame"] = "Montrer la fenêtre",
    ["Show the doused runes frame."] = "Montre la fenêtre pour les runes",
    ["Show on douse"] = "Montrer quand éteint",
    ["Show the display after a rune is doused."] = "Montre la fenêtre quand une personne éteint une rune.",
    ["Show on Boss Kill"] = "Montrer au kill du boss",
	["Show the display after a boss has been killed."] = "Montrer la fenêtre apres que le boss soit tué.",
    ["Reset position"] = "Raz de la position",
	["Reset the frame position."] = "Remise à zéro de la position de la fenetre",
} end)
-----------------------------------------------------------------------
--      Module Declaration
-----------------------------------------------------------------------
