...
L:RegisterTranslations("frFR", function() return {
	...
	["Respawn Timers"] = "Timer de Repop",
	["Respawn timer bars and warnings for trash mobs."] = "Timer et avertissement de repop des trashs",
	--["bars"] = "bars",
	["Bars"] = "Barres",
	["Toggles showing bars for respawn times."] = "Affiche ou non les barres de repop des trashs",
	--["messages"] = true,
	["Messages"] = "Messages",
	["Toggles showing messages for respawn times."] = "Affiche ou non les messages pour le repop des trashs",

	["%s %d respawns in %d sec"] = "%s %d repop dans %d sec",
	["%s %d respawned!"] = "%s %d à repop!",
	["Respawn: %s %d"] = "Repop: %s %d",
