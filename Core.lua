...
surface:Register("Armory", "Interface\\AddOns\\BigWigs_NG\\Textures\\Armory")
surface:Register("Otravi", "Interface\\AddOns\\BigWigs_NG\\Textures\\otravi")
surface:Register("Smooth", "Interface\\AddOns\\BigWigs_NG\\Textures\\smooth")
surface:Register("Glaze", "Interface\\AddOns\\BigWigs_NG\\Textures\\glaze")
surface:Register("Charcoal", "Interface\\AddOns\\BigWigs_NG\\Textures\\Charcoal")
surface:Register("BantoBar", "Interface\\AddOns\\BigWigs_NG\\Textures\\default")
...
L:RegisterTranslations("frFR", function() return {
	...
	["Target monitoring enabled"] = "Suivi des cibles activé",
	["Target monitoring disabled"] = "Suivi des cibles désactivé",
	["%s engaged!"] = "%s est engagé!",
	["%s has been defeated"] = "%s à été vaincu",     -- "<boss> has been defeated"
	["%s have been defeated"] = "%s ont été vaincu",    -- "<bosses> have been defeated"

	-- AceConsole strings
	--["boss"] = "jefe",
	["Bosses"] = "Boss",
	["Options for boss modules."] = "Options pour les modules de boss",
	...
	--["toggle"] = "alternar",
	["Active"] = "Activé",
	["Activate or deactivate this module."] = "Activer ou désactiver ce module",
	--["reboot"] = "reiniciar",
	--["rebootall"] = "reiniciartodos",
	["Reboot"] = "Redémarrer",
	["Reboot All"] = "Redémarrer tout",
	["Reboot this module."] = "Redémarrer ce module",
	--["debug"] = "depurar",
	["Debugging"] = "Débuggage",
	["Show debug messages."] = "Afficher les messages de d\195\169boguage.",
	["Forces the module to reset for everyone in the raid.\n\n(Requires assistant or higher)"] = "Oblige le module a redémarrer pour tout le monde dans le raid.\n\n(Requiers assist)",
	["%s has requested forced reboot for the %s module."] = "%s à envoyé une requête pour redémarrer le module %s",
	--bosskill_cmd = "kill",
	bosskill_name = "Défaite du boss",
	...
	["Naxxramas"] = "Naxxramas",
	["Silithus"] = "Silithus",
	["Outdoor Raid Bosses"] = "Extérieur",
	-- ["Outdoor Raid Bosses Zone"] = "Outdoor Raid Bosses", -- DO NOT EVER TRANSLATE untill I find a more elegant option

	--Name for exception bosses (neutrals that enable modules)
	["Vaelastrasz the Corrupt"] = "Vaelastrasz le Corompu",
	["Lord Victor Nefarius"] = "Seigneur Victor Nefarius",

	["You have slain %s!"] = "Vous avez vaincu %s!",
} end)
